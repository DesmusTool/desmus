        ...
        if(Auth::user() != null)
        {
            ...
            if($user[0] -> user_id == $user_id)
            {
                ...
                foreach($jobTSGaleries as $jobTSGalery)
                {
                    ...
                    $userJobTSGaleryInserts = DB::table('user_job_t_s_galeries')->where('job_t_s_galery_id', $jobTSGalery -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopicSection -> permissions]);
                    ...
                    if(isset($userJobTSGalery[0]))
                    {
                        ...
                        foreach($jobTSGaleryImages as $jobTSGaleryImage)
                        {
                            $userJobTSGImageInserts = DB::table('user_job_t_s_galery_images')->where('job_t_s_g_image_id', $jobTSGaleryImage -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopicSection -> permissions]);
                ...
                foreach($jobTSPlaylists as $jobTSPlaylist)
                {
                    ...
                    $userJobTSPlaylistInserts = DB::table('user_job_t_s_playlists')->where('j_t_s_p_id', $jobTSPlaylist -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopicSection -> permissions]);
                    ...
                    if(isset($userJobTSPlaylist[0]))
                    {
                        ...
                        foreach($jobTSPlaylistAudios as $jobTSPlaylistAudio)
                        {
                            $userJobTSPlaylistAudioInserts = DB::table('user_job_t_s_p_audios')->where('j_t_s_p_a_id', $jobTSPlaylistAudio -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopicSection -> permissions]);
                ...
                foreach($jobTSTools as $jobTSTool)
                {
                    ...
                    $userJobTSToolInserts = DB::table('user_job_t_s_tools')->where('job_t_s_tool_id', $jobTSTool -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopicSection -> permissions]);
                    ...
                    if(isset($userJobTSTool[0]))
                    {
                        ...
                        foreach($jobTSToolFiles as $jobTSToolFile)
                        {
                            $userJobTSToolFileInserts = DB::table('user_job_t_s_tool_files')->where('job_t_s_t_file_id', $jobTSToolFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopicSection -> permissions]);
