...
class GeneralSearchController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        if(Auth::user() != null)
        {
            ...
            $public_files = DB::table('public_file')->where('public_file.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('public_file.deleted_at', '=', null);})->orderBy('public_file.name', 'asc')->paginate(50);
            $public_notes = DB::table('public_note')->where('public_note.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('public_note.deleted_at', '=', null);})->orderBy('public_note.name', 'asc')->paginate(50);
            $public_images = DB::table('public_image')->where('public_image.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('public_image.deleted_at', '=', null);})->orderBy('public_image.name', 'asc')->paginate(50);
            $public_audios = DB::table('public_audio')->where('public_audio.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('public_audio.deleted_at', '=', null);})->orderBy('public_audio.name', 'asc')->paginate(50);
            $public_videos = DB::table('public_video')->where('public_video.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('public_video.deleted_at', '=', null);})->orderBy('public_video.name', 'asc')->paginate(50);
            $public_advertisements = DB::table('public_advertisement')->where('public_advertisement.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('public_advertisement.deleted_at', '=', null);})->orderBy('public_advertisement.name', 'asc')->paginate(50);

            $shared_profile_files = DB::table('shared_profile_file')->where('shared_profile_file.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('shared_profile_file.deleted_at', '=', null);})->orderBy('shared_profile_file.name', 'asc')->paginate(50);
            $shared_profile_notes = DB::table('shared_profile_note')->where('shared_profile_note.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('shared_profile_note.deleted_at', '=', null);})->orderBy('shared_profile_note.name', 'asc')->paginate(50);
            $shared_profile_images = DB::table('shared_profile_image')->where('shared_profile_image.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('shared_profile_image.deleted_at', '=', null);})->orderBy('shared_profile_image.name', 'asc')->paginate(50);
            $shared_profile_audios = DB::table('shared_profile_audio')->where('shared_profile_audio.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('shared_profile_audio.deleted_at', '=', null);})->orderBy('shared_profile_audio.name', 'asc')->paginate(50);
            $shared_profile_videos = DB::table('shared_profile_video')->where('shared_profile_video.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('shared_profile_video.deleted_at', '=', null);})->orderBy('shared_profile_video.name', 'asc')->paginate(50);

            $games = DB::table('games')->where('games.name','LIKE','%'.$request->search."%")->where(function ($query) {$query->where('user_id', '=', Auth::user()->id);})->where(function ($query) {$query->where('games.deleted_at', '=', null);})->orderBy('games.name', 'asc')->paginate(50);
            ...
            if($request->search)
            {
        		if($colleges->isNotEmpty())
         		...
         		if($public_files->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 'p_f_s', 'entity_id' => $public_files[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
         		...
         		if($public_notes->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 'p_n_s', 'entity_id' => $public_notes[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
         		...
         		if($public_images->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 'p_i_s', 'entity_id' => $public_images[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
         		...
         		if($public_audios->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 'p_a_s', 'entity_id' => $public_audios[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
         		...
         		if($public_videos->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 'p_v_s', 'entity_id' => $public_videos[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
         		...
         		if($public_advertisements->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 'p_a_s', 'entity_id' => $public_advertisements[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
         		...
         		if($shared_profile_files->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 's_p_f_s', 'entity_id' => $shared_profile_files[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
         		...
         		if($shared_profile_notes->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 's_p_n_s', 'entity_id' => $shared_profile_notes[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
         		...
         		if($shared_profile_images->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 's_p_i_s', 'entity_id' => $shared_profile_images[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
         		...
         		if($shared_profile_audios->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 's_p_a_s', 'entity_id' => $shared_profile_audios[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
         		...
         		if($shared_profile_videos->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 's_p_v_s', 'entity_id' => $shared_profile_videos[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
         		...
         		if($games->isNotEmpty())
         		{
         		    DB::table('general_search')->insert(['search' => $request->search, 'entity_type' => 'g_s', 'entity_id' => $games[0] -> id, 'user_id' => $user_id, 'updated_at' => $now]);
