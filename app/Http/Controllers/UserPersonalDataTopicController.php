        ...
        if(Auth::user() != null)
        {
            ...
            if($user[0] -> user_id == $user_id)
            {
                ...
                foreach($personalDataTopicSections as $personalDataTopicSection)
                {
                    ...
                    $userPersonalDataTopicSectionInserts = DB::table('user_personal_data_topic_sections')->where('personal_data_t_s_id', $personalDataTopicSection -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userPersonalDataTopic -> permissions]);
                    ...
                    if(isset($userPersonalDataTopicSection[0]))
                    {
                        ...
                        foreach($personalDataTSFiles as $personalDataTSFile)
                        {
                            $userPersonalDataTSFileInserts = DB::table('user_personal_data_t_s_files')->where('personal_data_t_s_file_id', $personalDataTSFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userPersonalDataTopic -> permissions]);
                        ...
                        foreach($personalDataTSNotes as $personalDataTSNote)
                        {
                            $userPersonalDataTSNoteInserts = DB::table('user_personal_data_t_s_notes')->where('personal_data_t_s_note_id', $personalDataTSNote -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userPersonalDataTopic -> permissions]);
                        ...
                        foreach($personalDataTSGaleries as $personalDataTSGalery)
                        {
                            ...
                            $userPersonalDataTSGaleryInserts = DB::table('user_personal_data_t_s_galeries')->where('personal_data_t_s_g_id', $personalDataTSGalery -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userPersonalDataTopic -> permissions]);
                            ...
                            if(isset($userPersonalDataTSGalery[0]))
                            {
                                ...
                                foreach($personalDataTSGaleryImages as $personalDataTSGaleryImage)
                                {
                                    $userPersonalDataTSGImageInserts = DB::table('user_personal_data_t_s_galery_images')->where('p_d_t_s_g_i_id', $personalDataTSGaleryImage -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userPersonalDataTopic -> permissions]);
                        ...
                        foreach($personalDataTSPlaylists as $personalDataTSPlaylist)
                        {
                            ...
                            $userPersonalDataTSPlaylistInserts = DB::table('user_personal_data_t_s_p')->where('p_d_t_s_p_id', $personalDataTSPlaylist -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userPersonalDataTopic -> permissions]);
                            ...
                            if(isset($userPersonalDataTSPlaylist[0]))
                            {
                                ...
                                foreach($personalDataTSPlaylistAudios as $personalDataTSPlaylistAudio)
                                {
                                    $userPersonalDataTSPlaylistAudioInserts = DB::table('user_p_d_t_s_p_audios')->where('p_d_t_s_p_a_id', $personalDataTSPlaylistAudio -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userPersonalDataTopic -> permissions]);
                        ...
                        foreach($personalDataTSTools as $personalDataTSTool)
                        {
                            ...
                            $userPersonalDataTSToolInserts = DB::table('user_personal_data_t_s_tools')->where('personal_data_t_s_tool_id', $personalDataTSTool -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userPersonalDataTopic -> permissions]);
                            ...
                            if(isset($userPersonalDataTSTool[0]))
                            {
                                ...
                                foreach($personalDataTSToolFiles as $personalDataTSToolFile)
                                {
                                    $userPersonalDataTSToolFileInserts = DB::table('user_personal_data_t_s_tool_files')->where('personal_d_t_s_t_f_id', $personalDataTSToolFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userPersonalDataTopic -> permissions]);
