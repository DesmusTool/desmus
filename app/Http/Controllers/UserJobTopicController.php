                            ...
                            if(isset($userJobTopicSection[0]))
                            {
                                ...
                                foreach($jobTSPlaylists as $jobTSPlaylist)
                                {
                                    ...
                                    if($sharedJobTSPlaylist->isEmpty())
                                    {
                                        ...
                                        {
                                            $sharedJobTSPlaylistAudio = DB::table('user_job_t_s_playlist_audios')->where('j_t_s_p_a_id', '=', $jobTSPlaylistAudio -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();
        ...
        if(Auth::user() != null)
        {
            ...
            if($user[0] -> user_id == $user_id)
            {
                ...
                foreach($jobTopicSections as $jobTopicSection)
                {
                    ...
                    $userJobTopicSectionInserts = DB::table('user_job_topic_sections')->where('job_topic_section_id', $jobTopicSection -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopic -> permissions]);
                    ...
                    if(isset($userJobTopicSection[0]))
                    {
                        ...
                        foreach($jobTSFiles as $jobTSFile)
                        {
                            $userJobTSFileInserts = DB::table('user_job_t_s_files')->where('job_t_s_file_id', $jobTSFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopic -> permissions]);
                        ...
                        foreach($jobTSNotes as $jobTSNote)
                        {
                            $userJobTSNoteInserts = DB::table('user_job_t_s_notes')->where('job_t_s_note_id', $jobTSNote -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopic -> permissions]);
                        ...
                        foreach($jobTSGaleries as $jobTSGalery)
                        {
                            ...
                            $userJobTSGaleryInserts = DB::table('user_job_t_s_galeries')->where('job_t_s_galery_id', $jobTSGalery -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopic -> permissions]);
                            ...
                            if(isset($userJobTSGalery[0]))
                            {
                                ...
                                foreach($jobTSGaleryImages as $jobTSGaleryImage)
                                {
                                    $userJobTSGImageInserts = DB::table('user_job_t_s_galery_images')->where('job_t_s_g_image_id', $jobTSGaleryImage -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopic -> permissions]);
                        ...
                        foreach($jobTSPlaylists as $jobTSPlaylist)
                        {
                            ...
                            $userJobTSPlaylistInserts = DB::table('user_job_t_s_playlists')->where('j_t_s_p_id', $jobTSPlaylist -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopic -> permissions]);
                            ...
                            if(isset($userJobTSPlaylist[0]))
                            {
                                ...
                                foreach($jobTSPlaylistAudios as $jobTSPlaylistAudio)
                                {
                                    $userJobTSPlaylistAudioInserts = DB::table('user_job_t_s_p_audios')->where('j_t_s_p_a_id', $jobTSPlaylistAudio -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopic -> permissions]);
                                    ...
                                    if($userJobTSPlaylistAudioInserts == 0)
                                    {
                                        ...
                                        $userJobTSPlaylistAudio = DB::table('user_job_t_s_p_audios')->where('j_t_s_p_a_id', '=', $jobTSPlaylistAudio -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('u_c_t_s_p_audio_creates')->insert(['datetime' => $now, 'user_id' => $user_id, 'u_c_t_s_p_a_id' => $userJobTSPlaylistAudio[0] -> id]);
                                    }
                        ...
                        foreach($jobTSTools as $jobTSTool)
                        {
                            ...
                            $userJobTSToolInserts = DB::table('user_job_t_s_tools')->where('job_t_s_tool_id', $jobTSTool -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopic -> permissions]);
                            ...
                            if(isset($userJobTSTool[0]))
                            {
                                ...
                                foreach($jobTSToolFiles as $jobTSToolFile)
                                {
                                    $userJobTSToolFileInserts = DB::table('user_job_t_s_tool_files')->where('job_t_s_t_file_id', $jobTSToolFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJobTopic -> permissions]);
