        ...
        if(Auth::user() != null)
        {
            ...
            if($userJobCheck->isEmpty())
            {
                if($user[0] -> user_id == $user_id)
                {
                    ...
                    {
                        $sharedJobTopic = DB::table('user_job_topics')->where('job_topic_id', '=', $jobTopic -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                        if($sharedJobTopic->isEmpty())
                        {
                            ...
                            if(isset($userJobTopic[0]))
                            {
                                ...
                                {
                                    $sharedJobTopicSection = DB::table('user_job_topic_sections')->where('job_topic_section_id', '=', $jobTopicSection -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                    if($sharedJobTopicSection->isEmpty())
                                    {
                                        ...
                                        if(isset($userJobTopicSection[0]))
                                        {
                                            ...
                                            {
                                                $sharedJobTSFile = DB::table('user_job_t_s_files')->where('job_t_s_file_id', '=', $jobTSFile -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedJobTSFile->isEmpty())
                                                {
                                            ...
                                            {
                                                $sharedJobTSNote = DB::table('user_job_t_s_notes')->where('job_t_s_note_id', '=', $jobTSNote -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedJobTSNote->isEmpty())
                                                {
                                            ...
                                            {
                                                $sharedJobTSGalery = DB::table('user_job_t_s_galeries')->where('job_t_s_galery_id', '=', $jobTSGalery -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedJobTSGalery->isEmpty())
                                                {
                                                    ...
                                                    if(isset($userJobTSGalery[0]))
                                                    {
                                                        ...
                                                        {
                                                            $sharedJobTSGaleryImage = DB::table('user_job_t_s_galery_images')->where('job_t_s_g_image_id', '=', $jobTSGaleryImage -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                            if($sharedJobTSGaleryImage->isEmpty())
                                                            {
                                            ...
                                            {
                                                $sharedJobTSPlaylist = DB::table('user_job_t_s_playlists')->where('j_t_s_p_id', '=', $jobTSPlaylist -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedJobTSPlaylist->isEmpty())
                                                {
                                                    ...
                                                    {
                                                        $sharedJobTSPlaylistAudio = DB::table('user_job_t_s_p_audios')->where('j_t_s_p_a_id', '=', $jobTSPlaylistAudio -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                        if($sharedJobTSPlaylistAudio->isEmpty())
                                                        {
                                            ...
                                            {
                                                $sharedJobTSTool = DB::table('user_job_t_s_tools')->where('job_t_s_tool_id', '=', $jobTSTool -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedJobTSTool->isEmpty())
                                                {
                                                    ...
                                                    if(isset($userJobTSTool[0]))
                                                    {
                                                        ...
                                                        {
                                                            $sharedJobTSToolFile = DB::table('user_job_t_s_tool_files')->where('job_t_s_t_file_id', '=', $jobTSToolFile -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                            if($sharedJobTSToolFile->isEmpty())
                                                            {
        ...
        if(Auth::user() != null)
        {
            ...
            if($user[0] -> user_id == $user_id)
            {
                ...
                foreach($jobTopics as $jobTopic)
                {
                    ...
                    $userJobTopicInserts = DB::table('user_job_topics')->where('job_topic_id', $jobTopic -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJob -> permissions]);
                    
                    if($userJobTopicInserts == 0)
                    {
                        DB::table('user_job_topics')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userJob -> description, 'permissions' => 'advanced', 'job_topic_id' => $jobTopic -> id]);
                        $userJobTopic = DB::table('user_job_topics')->where('job_topic_id', '=', $jobTopic -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                        DB::table('user_job_topic_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_j_t_id' => $userJobTopic[0] -> id]);
                    }
                    ...
                    if(isset($userJobTopic[0]))
                    {
                        ...
                        foreach($jobTopicSections as $jobTopicSection)
                        {
                            ...
                            $userJobTopicSectionInserts = DB::table('user_job_topic_sections')->where('job_topic_section_id', $jobTopicSection -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJob -> permissions]);
                            
                            if($userJobTopicSectionInserts == 0)
                            {
                                DB::table('user_job_topic_sections')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userJob -> description, 'permissions' => 'advanced', 'job_topic_section_id' => $jobTopicSection -> id]);
                                $userJobTopicSection = DB::table('user_job_topic_sections')->where('job_topic_section_id', '=', $jobTopicSection -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                DB::table('user_job_topic_section_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_j_t_s_id' => $userJobTopicSection[0] -> id]);
                            }
                            ...
                            if(isset($userJobTopicSection[0]))
                            {
                                ...
                                foreach($jobTSFiles as $jobTSFile)
                                {
                                    $userJobTSFileInserts = DB::table('user_job_t_s_files')->where('job_t_s_file_id', $jobTSFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJob -> permissions]);

                                    if($userJobTSFileInserts == 0)
                                    {
                                        DB::table('user_job_t_s_files')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userJob -> description, 'permissions' => 'advanced', 'job_t_s_file_id' => $jobTSFile -> id]);
                                        $userJobTSFile = DB::table('user_job_t_s_files')->where('job_t_s_file_id', '=', $jobTSFile -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_job_t_s_file_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_j_t_s_f_id' => $userJobTSFile[0] -> id]);
                                    }
                                ...
                                foreach($jobTSNotes as $jobTSNote)
                                {
                                    $userJobTSNoteInserts = DB::table('user_job_t_s_notes')->where('job_t_s_note_id', $jobTSNote -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJob -> permissions]);

                                    if($userJobTSNoteInserts == 0)
                                    {
                                        DB::table('user_job_t_s_notes')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userJob -> description, 'permissions' => 'advanced', 'job_t_s_note_id' => $jobTSNote -> id]);
                                        $userJobTSNote = DB::table('user_job_t_s_notes')->where('job_t_s_note_id', '=', $jobTSNote -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_job_t_s_note_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_j_t_s_n_id' => $userJobTSNote[0] -> id]);
                                    }
                                ...
                                foreach($jobTSGaleries as $jobTSGalery)
                                {
                                    ...
                                    $userJobTSGaleryInserts = DB::table('user_job_t_s_galeries')->where('job_t_s_galery_id', $jobTSGalery -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJob -> permissions]);

                                    if($userJobTSGaleryInserts == 0)
                                    {
                                        DB::table('user_job_t_s_galeries')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userJob -> description, 'permissions' => 'advanced', 'job_t_s_galery_id' => $jobTSGalery -> id]);
                                        $userJobTSGalery = DB::table('user_job_t_s_galeries')->where('job_t_s_galery_id', '=', $jobTSGalery -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_job_t_s_galerie_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_j_t_s_g_id' => $userJobTSGalery[0] -> id]);
                                    }
                                    ...
                                    if(isset($userJobTSGalery[0]))
                                    {
                                        ...
                                        foreach($jobTSGaleryImages as $jobTSGaleryImage)
                                        {
                                            $userJobTSGImageInserts = DB::table('user_job_t_s_galery_images')->where('job_t_s_g_image_id', $jobTSGaleryImage -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJob -> permissions]);

                                            if($userJobTSGImageInserts == 0)
                                            {
                                                DB::table('user_job_t_s_galery_images')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userJob -> description, 'permissions' => 'advanced', 'job_t_s_g_image_id' => $jobTSGaleryImage -> id]);
                                                $userJobTSGaleryImage = DB::table('user_job_t_s_galery_images')->where('job_t_s_g_image_id', '=', $jobTSGaleryImage -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                                DB::table('user_job_t_s_galery_image_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_j_t_s_g_i_id' => $userJobTSGaleryImage[0] -> id]);
                                            }
                                ...
                                foreach($jobTSPlaylists as $jobTSPlaylist)
                                {
                                    ...
                                    $userJobTSPlaylistInserts = DB::table('user_job_t_s_playlists')->where('j_t_s_p_id', $jobTSPlaylist -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJob -> permissions]);

                                    if($userJobTSPlaylistInserts == 0)
                                    {
                                        DB::table('user_job_t_s_playlists')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userJob -> description, 'permissions' => 'advanced', 'j_t_s_p_id' => $jobTSPlaylist -> id]);
                                        $userJobTSPlaylist = DB::table('user_job_t_s_playlists')->where('j_t_s_p_id', '=', $jobTSPlaylist -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('u_j_t_s_playlist_creates')->insert(['datetime' => $now, 'user_id' => $user_id, 'u_j_t_s_p_id' => $userJobTSPlaylist[0] -> id]);
                                    }
                                    ...
                                    if(isset($userJobTSPlaylist[0]))
                                    {
                                        ...
                                        foreach($jobTSPlaylistAudios as $jobTSPlaylistAudio)
                                        {
                                            $userJobTSPlaylistAudioInserts = DB::table('user_job_t_s_p_audios')->where('j_t_s_p_a_id', $jobTSPlaylistAudio -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJob -> permissions]);

                                            if($userJobTSPlaylistAudioInserts == 0)
                                            {
                                                DB::table('user_job_t_s_p_audios')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userJob -> description, 'permissions' => 'advanced', 'j_t_s_p_a_id' => $jobTSPlaylistAudio -> id]);
                                                $userJobTSPlaylistAudio = DB::table('user_job_t_s_p_audios')->where('j_t_s_p_a_id', '=', $jobTSPlaylistAudio -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                                DB::table('u_j_t_s_p_audio_creates')->insert(['datetime' => $now, 'user_id' => $user_id, 'u_j_t_s_p_a_id' => $userJobTSPlaylistAudio[0] -> id]);
                                            }
                                ...
                                foreach($jobTSTools as $jobTSTool)
                                {
                                    ...
                                    $userJobTSToolInserts = DB::table('user_job_t_s_tools')->where('job_t_s_tool_id', $jobTSTool -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJob -> permissions]);

                                    if($userJobTSToolInserts == 0)
                                    {
                                        DB::table('user_job_t_s_tools')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userJob -> description, 'permissions' => 'advanced', 'job_t_s_tool_id' => $jobTSTool -> id]);
                                        $userJobTSTool = DB::table('user_job_t_s_tools')->where('job_t_s_tool_id', '=', $jobTSTool -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_job_t_s_tool_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_j_t_s_t_id' => $userJobTSTool[0] -> id]);
                                    }
                                    ...
                                    if(isset($userJobTSTool[0]))
                                    {
                                        ...
                                        foreach($jobTSToolFiles as $jobTSToolFile)
                                        {
                                            $userJobTSToolFileInserts = DB::table('user_job_t_s_tool_files')->where('job_t_s_t_file_id', $jobTSToolFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userJob -> permissions]);

                                            if($userJobTSToolFileInserts == 0)
                                            {
                                                DB::table('user_job_t_s_tool_files')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userJob -> description, 'permissions' => 'advanced', 'job_t_s_t_file_id' => $jobTSToolFile -> id]);
                                                $userJobTSToolFile = DB::table('user_job_t_s_tool_files')->where('job_t_s_t_file_id', '=', $jobTSToolFile -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                                DB::table('user_job_t_s_tool_file_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_j_t_s_t_f_id' => $userJobTSToolFile[0] -> id]);
                                            }
