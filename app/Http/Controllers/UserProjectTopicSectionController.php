        ...
        if(Auth::user() != null)
        {
            ...
            if($user[0] -> user_id == $user_id)
            {
                ...
                foreach($projectTSGaleries as $projectTSGalery)
                {
                    ...
                    $userProjectTSGaleryInserts = DB::table('user_project_t_s_galeries')->where('project_t_s_galery_id', $projectTSGalery -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProjectTopicSection -> permissions]);
                    ...
                    if(isset($userProjectTSGalery[0]))
                    {
                        ...
                        foreach($projectTSGaleryImages as $projectTSGaleryImage)
                        {
                            $userProjectTSGImageInserts = DB::table('user_project_t_s_galery_images')->where('project_t_s_g_image_id', $projectTSGaleryImage -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProjectTopicSection -> permissions]);
                            ...
                            if($userProjectTSGImageInserts == 0)
                            {
                                ...
                                $userProjectTSGaleryImage = DB::table('user_project_t_s_galery_images')->where('project_t_s_g_image_id', '=', $projectTSGaleryImage[0] -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                DB::table('user_project_t_s_galery_image_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_p_t_s_g_i_id' => $userProjectTSGaleryImage[0] -> id]);
                            }
                ...
                foreach($projectTSPlaylists as $projectTSPlaylist)
                {
                    ...
                    $userProjectTSPlaylistInserts = DB::table('user_project_t_s_playlists')->where('p_t_s_p_id', $projectTSPlaylist -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProjectTopicSection -> permissions]);
                    ...
                    if(isset($userProjectTSPlaylist[0]))
                    {
                        ...
                        foreach($projectTSPlaylistAudios as $projectTSPlaylistAudio)
                        {
                            $userProjectTSPlaylistAudioInserts = DB::table('user_project_t_s_p_audios')->where('p_t_s_p_a_id', $projectTSPlaylistAudio -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProjectTopicSection -> permissions]);
                ...
                foreach($projectTSTools as $projectTSTool)
                {
                    ...
                    $userProjectTSToolInserts = DB::table('user_project_t_s_tools')->where('project_t_s_tool_id', $projectTSTool -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProjectTopicSection -> permissions]);
                    ...
                    if(isset($userProjectTSTool[0]))
                    {
                        ...
                        foreach($projectTSToolFiles as $projectTSToolFile)
                        {
                            $userProjectTSToolFileInserts = DB::table('user_project_t_s_tool_files')->where('project_t_s_t_file_id', $projectTSToolFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProjectTopicSection -> permissions]);
