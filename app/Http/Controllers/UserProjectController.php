        ...
        if(Auth::user() != null)
        {
            ...
            if($userProjectCheck->isEmpty())
            {
                if($user[0] -> user_id == $user_id)
                {
                    ...
                    {
                        $sharedProjectTopic = DB::table('user_project_topics')->where('project_topic_id', '=', $projectTopic -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                        if($sharedProjectTopic->isEmpty())
                        {
                            ...
                            if(isset($userProjectTopic[0]))
                            {
                                ...
                                {
                                    $sharedProjectTopicSection = DB::table('user_project_topic_sections')->where('project_topic_section_id', '=', $projectTopicSection -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                    if($sharedProjectTopicSection->isEmpty())
                                    {
                                        ...
                                        if(isset($userProjectTopicSection[0]))
                                        {
                                            ...
                                            {
                                                $sharedProjectTSFile = DB::table('user_project_t_s_files')->where('project_t_s_file_id', '=', $projectTSFile -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedProjectTSFile->isEmpty())
                                                {
                                            ...
                                            {
                                                $sharedProjectTSNote = DB::table('user_project_t_s_notes')->where('project_t_s_note_id', '=', $projectTSNote -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedProjectTSNote->isEmpty())
                                                {
                                            ...
                                            {
                                                $sharedProjectTSGalery = DB::table('user_project_t_s_galeries')->where('project_t_s_galery_id', '=', $projectTSGalery -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedProjectTSGalery->isEmpty())
                                                {
                                                    ...
                                                    if(isset($userProjectTSGalery[0]))
                                                    {
                                                        ...
                                                        {
                                                            $sharedProjectTSGaleryImage = DB::table('user_project_t_s_galery_images')->where('project_t_s_g_image_id', '=', $projectTSGaleryImage -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                            if($sharedProjectTSGaleryImage->isEmpty())
                                                            {
                                            ...
                                            {
                                                $sharedProjectTSPlaylist = DB::table('user_project_t_s_playlists')->where('p_t_s_p_id', '=', $projectTSPlaylist -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedProjectTSPlaylist->isEmpty())
                                                {
                                                    ...
                                                    {
                                                        $sharedProjectTSPlaylistAudio = DB::table('user_project_t_s_p_audios')->where('p_t_s_p_a_id', '=', $projectTSPlaylistAudio -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                        if($sharedProjectTSPlaylistAudio->isEmpty())
                                                        {
                                            ...
                                            {
                                                $sharedProjectTSTool = DB::table('user_project_t_s_tools')->where('project_t_s_tool_id', '=', $projectTSTool -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedProjectTSTool->isEmpty())
                                                {
                                                    ...
                                                    if(isset($userProjectTSTool[0]))
                                                    {
                                                        ...
                                                        {
                                                            $sharedProjectTSToolFile = DB::table('user_project_t_s_tool_files')->where('project_t_s_t_file_id', '=', $projectTSToolFile -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                            if($sharedProjectTSToolFile->isEmpty())
                                                            {
        ...
        if(Auth::user() != null)
        {
            ...
            if($user[0] -> user_id == $user_id)
            {
                ...
                foreach($projectTopics as $projectTopic)
                {
                    ...
                    $userProjectTopicInserts = DB::table('user_project_topics')->where('project_topic_id', $projectTopic -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProject -> permissions]);
                    
                    if($userProjectTopicInserts == 0)
                    {
                        DB::table('user_project_topics')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userProject -> description, 'permissions' => 'advanced', 'project_topic_id' => $projectTopic -> id]);
                        $userProjectTopic = DB::table('user_project_topics')->where('project_topic_id', '=', $projectTopic -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                        DB::table('user_project_topic_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_p_t_id' => $userProjectTopic[0] -> id]);
                    }
                    ...
                    if(isset($userProjectTopic[0]))
                    {
                        ...
                        foreach($projectTopicSections as $projectTopicSection)
                        {
                            ...
                            $userProjectTopicSectionInserts = DB::table('user_project_topic_sections')->where('project_topic_section_id', $projectTopicSection -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProject -> permissions]);

                            if($userProjectTopicSectionInserts == 0)
                            {
                                DB::table('user_project_topic_sections')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userProject -> description, 'permissions' => 'advanced', 'project_topic_section_id' => $projectTopicSection -> id]);
                                $userProjectTopicSection = DB::table('user_project_topic_sections')->where('project_topic_section_id', '=', $projectTopicSection -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                DB::table('user_project_topic_section_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_p_t_s_id' => $userProjectTopicSection[0] -> id]);
                            }
                            ...
                            if(isset($userProjectTopicSection[0]))
                            {
                                ...
                                foreach($projectTSFiles as $projectTSFile)
                                {
                                    $userProjectTSFileInserts = DB::table('user_project_t_s_files')->where('project_t_s_file_id', $projectTSFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProject -> permissions]);

                                    if($userProjectTSFileInserts == 0)
                                    {
                                        DB::table('user_project_t_s_files')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userProject -> description, 'permissions' => 'advanced', 'project_t_s_file_id' => $projectTSFile -> id]);
                                        $userProjectTSFile = DB::table('user_project_t_s_files')->where('project_t_s_file_id', '=', $projectTSFile -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_project_t_s_file_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_p_t_s_f_id' => $userProjectTSFile[0] -> id]);
                                    }
                                ...
                                foreach($projectTSNotes as $projectTSNote)
                                {
                                    $userProjectTSNoteInserts = DB::table('user_project_t_s_notes')->where('project_t_s_note_id', $projectTSNote -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProject -> permissions]);

                                    if($userProjectTSNoteInserts == 0)
                                    {
                                        DB::table('user_project_t_s_notes')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userProject -> description, 'permissions' => 'advanced', 'project_t_s_note_id' => $projectTSNote -> id]);
                                        $userProjectTSNote = DB::table('user_project_t_s_notes')->where('project_t_s_note_id', '=', $projectTSNote -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_project_t_s_note_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_p_t_s_n_id' => $userProjectTSNote[0] -> id]);
                                    }
                                ...
                                foreach($projectTSGaleries as $projectTSGalery)
                                {
                                    ...
                                    $userProjectTSGaleryInserts = DB::table('user_project_t_s_galeries')->where('project_t_s_galery_id', $projectTSGalery -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProject -> permissions]);

                                    if($userProjectTSGaleryInserts == 0)
                                    {
                                        DB::table('user_project_t_s_galeries')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userProject -> description, 'permissions' => 'advanced', 'project_t_s_galery_id' => $projectTSGalery -> id]);
                                        $userProjectTSGalery = DB::table('user_project_t_s_galeries')->where('project_t_s_galery_id', '=', $projectTSGalery -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_project_t_s_galerie_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_p_t_s_g_id' => $userProjectTSGalery[0] -> id]);
                                    }
                                    ...
                                    if(isset($userProjectTSGalery[0]))
                                    {
                                        ...
                                        foreach($projectTSGaleryImages as $projectTSGaleryImage)
                                        {
                                            $userProjectTSGImageInserts = DB::table('user_project_t_s_galery_images')->where('project_t_s_g_image_id', $projectTSGaleryImage -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProject -> permissions]);

                                            if($userProjectTSGImageInserts == 0)
                                            {
                                                DB::table('user_project_t_s_galery_images')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userProject -> description, 'permissions' => 'advanced', 'project_t_s_g_image_id' => $projectTSGaleryImage -> id]);
                                                $userProjectTSGaleryImage = DB::table('user_project_t_s_galery_images')->where('project_t_s_g_image_id', '=', $projectTSGaleryImage -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                                DB::table('user_project_t_s_galery_image_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_p_t_s_g_i_id' => $userProjectTSGaleryImage[0] -> id]);
                                            }
                                ...
                                foreach($projectTSPlaylists as $projectTSPlaylist)
                                {
                                    ...
                                    $userProjectTSPlaylistInserts = DB::table('user_project_t_s_playlists')->where('p_t_s_p_id', $projectTSPlaylist -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProject -> permissions]);

                                    if($userProjectTSPlaylistInserts == 0)
                                    {
                                        DB::table('user_project_t_s_playlists')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userProject -> description, 'permissions' => 'advanced', 'p_t_s_p_id' => $projectTSPlaylist -> id]);
                                        $userProjectTSPlaylist = DB::table('user_project_t_s_playlists')->where('p_t_s_p_id', '=', $projectTSPlaylist -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('u_p_t_s_playlist_creates')->insert(['datetime' => $now, 'user_id' => $user_id, 'u_p_t_s_p_id' => $userProjectTSPlaylist[0] -> id]);
                                    }
                                    ...
                                    if(isset($userProjectTSPlaylist[0]))
                                    {
                                        ...
                                        foreach($projectTSPlaylistAudios as $projectTSPlaylistAudio)
                                        {
                                            $userProjectTSPlaylistAudioInserts = DB::table('user_project_t_s_p_audios')->where('p_t_s_p_a_id', $projectTSPlaylistAudio -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProject -> permissions]);

                                            if($userProjectTSPlaylistAudioInserts == 0)
                                            {
                                                DB::table('user_project_t_s_p_audios')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userProject -> description, 'permissions' => 'advanced', 'p_t_s_p_a_id' => $projectTSPlaylistAudio -> id]);
                                                $userProjectTSPlaylistAudio = DB::table('user_project_t_s_p_audios')->where('p_t_s_p_a_id', '=', $projectTSPlaylistAudio -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                                DB::table('u_p_t_s_p_audio_creates')->insert(['datetime' => $now, 'user_id' => $user_id, 'u_p_t_s_p_a_id' => $userProjectTSPlaylistAudio[0] -> id]);
                                            }
                                ...
                                foreach($projectTSTools as $projectTSTool)
                                {
                                    ...
                                    $userProjectTSToolInserts = DB::table('user_project_t_s_tools')->where('project_t_s_tool_id', $projectTSTool -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProject -> permissions]);

                                    if($userProjectTSToolInserts == 0)
                                    {
                                        DB::table('user_project_t_s_tools')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userProject -> description, 'permissions' => 'advanced', 'project_t_s_tool_id' => $projectTSTool -> id]);
                                        $userProjectTSTool = DB::table('user_project_t_s_tools')->where('project_t_s_tool_id', '=', $projectTSTool -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_project_t_s_tool_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_p_t_s_t_id' => $userProjectTSTool[0] -> id]);
                                    }
                                    ...
                                    if(isset($userProjectTSTool[0]))
                                    {
                                        ...
                                        foreach($projectTSToolFiles as $projectTSToolFile)
                                        {
                                            $userProjectTSToolFileInserts = DB::table('user_project_t_s_tool_files')->where('project_t_s_t_file_id', $projectTSToolFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userProject -> permissions]);

                                            if($userProjectTSToolFileInserts == 0)
                                            {
                                                DB::table('user_project_t_s_tool_files')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userProject -> description, 'permissions' => 'advanced', 'project_t_s_t_file_id' => $projectTSToolFile -> id]);
                                                $userProjectTSToolFile = DB::table('user_project_t_s_tool_files')->where('project_t_s_t_file_id', '=', $projectTSToolFile -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                                DB::table('user_project_t_s_tool_file_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_p_t_s_t_f_id' => $userProjectTSToolFile[0] -> id]);
                                            }
