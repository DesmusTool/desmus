        ...
        if(Auth::user() != null)
        {
            ...
            if($userCollegeCheck->isEmpty())
            {
                if($user[0] -> user_id == $user_id)
                {
                    ...
                    {
                        $sharedCollegeTopic = DB::table('user_college_topics')->where('college_topic_id', '=', $collegeTopic -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                        if($sharedCollegeTopic->isEmpty())
                        {
                            ...
                            if(isset($userCollegeTopic[0]))
                            {
                                ...
                                {
                                    $sharedCollegeTopicSection = DB::table('user_college_topic_sections')->where('college_topic_section_id', '=', $collegeTopicSection -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                    if($sharedCollegeTopicSection->isEmpty())
                                    {
                                        ...
                                        if(isset($userCollegeTopicSection[0]))
                                        {
                                            ...
                                            {
                                                $sharedCollegeTSFile = DB::table('user_college_t_s_files')->where('college_t_s_file_id', '=', $collegeTSFile -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedCollegeTSFile->isEmpty())
                                                {
                                            ...
                                            {
                                                $sharedCollegeTSNote = DB::table('user_college_t_s_notes')->where('college_t_s_note_id', '=', $collegeTSNote -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedCollegeTSNote->isEmpty())
                                                {
                                            ...
                                            {
                                                $sharedCollegeTSGalery = DB::table('user_college_t_s_galeries')->where('college_t_s_galery_id', '=', $collegeTSGalery -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedCollegeTSGalery->isEmpty())
                                                {
                                                    ...
                                                    if(isset($userCollegeTSGalery[0]))
                                                    {
                                                        ...
                                                        {
                                                            $sharedCollegeTSGaleryImage = DB::table('user_college_t_s_galery_images')->where('college_t_s_g_image_id', '=', $collegeTSGaleryImage -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                            if($sharedCollegeTSGaleryImage->isEmpty())
                                                            {
                                            ...
                                            {
                                                $sharedCollegeTSPlaylist = DB::table('user_college_t_s_playlists')->where('c_t_s_p_id', '=', $collegeTSPlaylist -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedCollegeTSPlaylist->isEmpty())
                                                {
                                                    ...
                                                    {
                                                        $sharedCollegeTSPlaylistAudio = DB::table('user_college_t_s_p_audios')->where('c_t_s_p_a_id', '=', $collegeTSPlaylistAudio -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                        if($sharedCollegeTSPlaylistAudio->isEmpty())
                                                        {
                                            ...
                                            {
                                                $sharedCollegeTSTool = DB::table('user_college_t_s_tools')->where('college_t_s_tool_id', '=', $collegeTSTool -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                if($sharedCollegeTSTool->isEmpty())
                                                {
                                                    ...
                                                    if(isset($userCollegeTSTool[0]))
                                                    {
                                                        ...
                                                        {
                                                            $sharedCollegeTSToolFile = DB::table('user_college_t_s_tool_files')->where('college_t_s_t_file_id', '=', $collegeTSToolFile -> id)->where('user_id', '=', $input["user_id"])->where(function ($query) {$query->where('deleted_at', '=', null);})->get();

                                                            if($sharedCollegeTSToolFile->isEmpty())
                                                            {
        ...
        if(Auth::user() != null)
        {
            ...
            if($user[0] -> user_id == $user_id)
            {
                ...
                foreach($collegeTopics as $collegeTopic)
                {
                    ...
                    $userCollegeTopicInserts = DB::table('user_college_topics')->where('college_topic_id', $collegeTopic -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userCollege -> permissions]);

                    if($userCollegeTopicInserts == 0)
                    {
                        DB::table('user_college_topics')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userCollege -> description, 'permissions' => 'advanced', 'college_topic_id' => $collegeTopic -> id]);
                        $userCollegeTopic = DB::table('user_college_topics')->where('college_topic_id', '=', $collegeTopic -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                        DB::table('user_college_topic_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_c_t_id' => $userCollegeTopic[0] -> id]);
                    }
                    ...
                    if(isset($userCollegeTopic[0]))
                    {
                        ...
                        foreach($collegeTopicSections as $collegeTopicSection)
                        {
                            ...
                            $userCollegeTopicSectionInserts = DB::table('user_college_topic_sections')->where('college_topic_section_id', $collegeTopicSection -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userCollege -> permissions]);

                            if($userCollegeTopicSectionInserts == 0)
                            {
                                DB::table('user_college_topic_sections')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userCollege -> description, 'permissions' => 'advanced', 'college_topic_section_id' => $collegeTopicSection -> id]);
                                $userCollegeTopicSection = DB::table('user_college_topic_sections')->where('college_topic_section_id', '=', $collegeTopicSection -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                DB::table('user_college_topic_section_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_c_t_s_id' => $userCollegeTopicSection[0] -> id]);
                            }
                            ...
                            if(isset($userCollegeTopicSection[0]))
                            {
                                ...
                                foreach($collegeTSFiles as $collegeTSFile)
                                {
                                    $userCollegeTSFileInserts = DB::table('user_college_t_s_files')->where('college_t_s_file_id', $collegeTSFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userCollege -> permissions]);

                                    if($userCollegeTSFileInserts == 0)
                                    {
                                        DB::table('user_college_t_s_files')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userCollege -> description, 'permissions' => 'advanced', 'college_t_s_file_id' => $collegeTSFile -> id]);
                                        $userCollegeTSFile = DB::table('user_college_t_s_files')->where('college_t_s_file_id', '=', $collegeTSFile -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_college_t_s_file_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_c_t_s_f_id' => $userCollegeTSFile[0] -> id]);
                                    }
                                ...
                                foreach($collegeTSNotes as $collegeTSNote)
                                {
                                    $userCollegeTSNoteInserts = DB::table('user_college_t_s_notes')->where('college_t_s_note_id', $collegeTSNote -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userCollege -> permissions]);

                                    if($userCollegeTSNoteInserts == 0)
                                    {
                                        DB::table('user_college_t_s_notes')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userCollege -> description, 'permissions' => 'advanced', 'college_t_s_note_id' => $collegeTSNote -> id]);
                                        $userCollegeTSNote = DB::table('user_college_t_s_notes')->where('college_t_s_note_id', '=', $collegeTSNote -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_college_t_s_note_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_c_t_s_n_id' => $userCollegeTSNote[0] -> id]);
                                    }
                                ...
                                foreach($collegeTSGaleries as $collegeTSGalery)
                                {
                                    ...
                                    $userCollegeTSGaleryInserts = DB::table('user_college_t_s_galeries')->where('college_t_s_galery_id', $collegeTSGalery -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userCollege -> permissions]);

                                    if($userCollegeTSGaleryInserts == 0)
                                    {
                                        DB::table('user_college_t_s_galeries')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userCollege -> description, 'permissions' => 'advanced', 'college_t_s_galery_id' => $collegeTSGalery -> id]);
                                        $userCollegeTSGalery = DB::table('user_college_t_s_galeries')->where('college_t_s_galery_id', '=', $collegeTSGalery -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_college_t_s_galerie_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_c_t_s_g_id' => $userCollegeTSGalery[0] -> id]);
                                    }
                                    ...
                                    if(isset($userCollegeTSGalery[0]))
                                    {
                                        ...
                                        foreach($collegeTSGaleryImages as $collegeTSGaleryImage)
                                        {
                                            $userCollegeTSGImageInserts = DB::table('user_college_t_s_galery_images')->where('college_t_s_g_image_id', $collegeTSGaleryImage -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userCollege -> permissions]);

                                            if($userCollegeTSGImageInserts == 0)
                                            {
                                                DB::table('user_college_t_s_galery_images')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userCollege -> description, 'permissions' => 'advanced', 'college_t_s_g_image_id' => $collegeTSGaleryImage -> id]);
                                                $userCollegeTSGaleryImage = DB::table('user_college_t_s_galery_images')->where('college_t_s_g_image_id', '=', $collegeTSGaleryImage -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                                DB::table('user_college_t_s_galery_image_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_c_t_s_g_i_id' => $userCollegeTSGaleryImage[0] -> id]);
                                            }
                                ...
                                foreach($collegeTSPlaylists as $collegeTSPlaylist)
                                {
                                    ...
                                    $userCollegeTSPlaylistInserts = DB::table('user_college_t_s_playlists')->where('c_t_s_p_id', $collegeTSPlaylist -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userCollege -> permissions]);

                                    if($userCollegeTSPlaylistInserts == 0)
                                    {
                                        DB::table('user_college_t_s_playlists')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userCollege -> description, 'permissions' => 'advanced', 'c_t_s_p_id' => $collegeTSPlaylist -> id]);
                                        $userCollegeTSPlaylist = DB::table('user_college_t_s_playlists')->where('c_t_s_p_id', '=', $collegeTSPlaylist -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('u_c_t_s_playlist_creates')->insert(['datetime' => $now, 'user_id' => $user_id, 'u_c_t_s_p_id' => $userCollegeTSPlaylist[0] -> id]);
                                    }
                                    ...
                                    if(isset($userCollegeTSPlaylist[0]))
                                    {
                                        ...
                                        foreach($collegeTSPlaylistAudios as $collegeTSPlaylistAudio)
                                        {
                                            $userCollegeTSPlaylistAudioInserts = DB::table('user_college_t_s_p_audios')->where('c_t_s_p_a_id', $collegeTSPlaylistAudio -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userCollege -> permissions]);

                                            if($userCollegeTSPlaylistAudioInserts == 0)
                                            {
                                                DB::table('user_college_t_s_p_audios')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userCollege -> description, 'permissions' => 'advanced', 'c_t_s_p_a_id' => $collegeTSPlaylistAudio -> id]);
                                                $userCollegeTSPlaylistAudio = DB::table('user_college_t_s_p_audios')->where('c_t_s_p_a_id', '=', $collegeTSPlaylistAudio -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                                DB::table('u_c_t_s_p_audio_creates')->insert(['datetime' => $now, 'user_id' => $user_id, 'u_c_t_s_p_a_id' => $userCollegeTSPlaylistAudio[0] -> id]);
                                            }
                                ...
                                foreach($collegeTSTools as $collegeTSTool)
                                {
                                    ...
                                    $userCollegeTSToolInserts = DB::table('user_college_t_s_tools')->where('college_t_s_tool_id', $collegeTSTool -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userCollege -> permissions]);

                                    if($userCollegeTSToolInserts == 0)
                                    {
                                        DB::table('user_college_t_s_tools')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userCollege -> description, 'permissions' => 'advanced', 'college_t_s_tool_id' => $collegeTSTool -> id]);
                                        $userCollegeTSTool = DB::table('user_college_t_s_tools')->where('college_t_s_tool_id', '=', $collegeTSTool -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                        DB::table('user_college_t_s_tool_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_c_t_s_t_id' => $userCollegeTSTool[0] -> id]);
                                    }
                                    ...
                                    if(isset($userCollegeTSTool[0]))
                                    {
                                        ...
                                        foreach($collegeTSToolFiles as $collegeTSToolFile)
                                        {
                                            $userCollegeTSToolFileInserts = DB::table('user_college_t_s_tool_files')->where('college_t_s_t_file_id', $collegeTSToolFile -> id)->where('user_id', '=', $user_id)->update(['permissions' => $userCollege -> permissions]);

                                            if($userCollegeTSToolFileInserts == 0)
                                            {
                                                DB::table('user_college_t_s_tool_files')->insert(['datetime' => $now, 'user_id' => $user_id, 'description' => $userCollege -> description, 'permissions' => 'advanced', 'college_t_s_t_file_id' => $collegeTSToolFile -> id]);
                                                $userCollegeTSToolFile = DB::table('user_college_t_s_tool_files')->where('college_t_s_t_file_id', '=', $collegeTSToolFile -> id)->orderBy('datetime', 'desc')->limit(1)->get();
                                                DB::table('user_college_t_s_tool_file_c')->insert(['datetime' => $now, 'user_id' => $user_id, 'user_c_t_s_t_f_id' => $userCollegeTSToolFile[0] -> id]);
                                            }
