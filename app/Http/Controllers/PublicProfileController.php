...
class PublicProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        if(isset(Auth::user()->id))
        {
            ...
            $files = DB::table('public_file')->where('user_id', $user_id)->where(function ($query) {$query->where('public_file.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(100, ['*'], 'file_p');
            $notes = DB::table('public_note')->where('user_id', $user_id)->where(function ($query) {$query->where('public_note.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(100, ['*'], 'note_p');
            $images = DB::table('public_image')->where('user_id', $user_id)->where(function ($query) {$query->where('public_image.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(100, ['*'], 'image_p');
            $audios = DB::table('public_audio')->where('user_id', $user_id)->where(function ($query) {$query->where('public_audio.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(100, ['*'], 'audio_p');
            $videos = DB::table('public_video')->where('user_id', $user_id)->where(function ($query) {$query->where('public_video.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(100, ['*'], 'video_p');
            $advertisements = DB::table('public_advertisement')->where('user_id', $user_id)->where(function ($query) {$query->where('public_advertisement.deleted_at', '=', null);})->orderBy('created_at', 'desc')->paginate(100, ['*'], 'advertising_p');
        
            $public_file_comments_list = DB::table('public_file_comment')->join('public_file', 'public_file.id', '=', 'public_file_comment.public_file_id')->select('public_file.id', 'public_file.name', 'public_file_comment.content', 'public_file_comment.created_at')->where('public_file_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_file_comment.deleted_at', '=', null);})->orderBy('public_file_comment.created_at', 'desc')->paginate(50, ['*'], 'file_comment_list_p');
            $public_file_comment_responses_list = DB::table('public_file_comment_response')->join('public_file_comment', 'public_file_comment.id', '=', 'public_file_comment_response.public_file_comment_id')->join('public_file', 'public_file.id', '=', 'public_file_comment.public_file_id')->select('public_file.id', 'public_file.name', 'public_file_comment_response.content', 'public_file_comment_response.created_at')->where('public_file_comment_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_file_comment_response.deleted_at', '=', null);})->orderBy('public_file_comment_response.created_at', 'desc')->paginate(50, ['*'], 'file_comment_response_list_p');
            $public_file_likes_list_c = DB::table('public_file_like')->join('public_file', 'public_file.id', '=', 'public_file_like.public_file_id')->select('public_file.id', 'public_file.name', 'public_file_like.created_at')->where('public_file_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_file_like.deleted_at', '=', null);})->orderBy('public_file_like.created_at', 'desc')->paginate(50, ['*'], 'file_like_list_p');
    
            $public_file_comments_list_count = DB::table('public_file_comment')->join('public_file', 'public_file.id', '=', 'public_file_comment.public_file_id')->where('public_file_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_file_comment.deleted_at', '=', null);})->count();
            $public_file_comment_responses_list_count = DB::table('public_file_comment_response')->join('public_file_comment', 'public_file_comment.id', '=', 'public_file_comment_response.public_file_comment_id')->join('public_file', 'public_file.id', '=', 'public_file_comment.public_file_id')->where('public_file_comment_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_file_comment_response.deleted_at', '=', null);})->count();
            $public_file_likes_list_count = DB::table('public_file_like')->join('public_file', 'public_file.id', '=', 'public_file_like.public_file_id')->where('public_file_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_file_like.deleted_at', '=', null);})->count();
        
            $public_note_comments_list = DB::table('public_note_comment')->join('public_note', 'public_note.id', '=', 'public_note_comment.public_note_id')->select('public_note.id', 'public_note.name', 'public_note_comment.content', 'public_note_comment.created_at')->where('public_note_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_note_comment.deleted_at', '=', null);})->orderBy('public_note_comment.created_at', 'desc')->paginate(50, ['*'], 'note_comment_list_p');
            $public_note_comment_responses_list = DB::table('public_note_comment_response')->join('public_note_comment', 'public_note_comment.id', '=', 'public_note_comment_response.public_note_comment_id')->join('public_note', 'public_note.id', '=', 'public_note_comment.public_note_id')->select('public_note.id', 'public_note.name', 'public_note_comment_response.content', 'public_note_comment_response.created_at')->where('public_note_comment_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_note_comment_response.deleted_at', '=', null);})->orderBy('public_note_comment_response.created_at', 'desc')->paginate(50, ['*'], 'note_comment_response_list_p');
            $public_note_likes_list_c = DB::table('public_note_like')->join('public_note', 'public_note.id', '=', 'public_note_like.public_note_id')->select('public_note.id', 'public_note.name', 'public_note_like.created_at')->where('public_note_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_note_like.deleted_at', '=', null);})->orderBy('public_note_like.created_at', 'desc')->paginate(50, ['*'], 'note_like_list_p');
    
            $public_note_comments_list_count = DB::table('public_note_comment')->join('public_note', 'public_note.id', '=', 'public_note_comment.public_note_id')->where('public_note_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_note_comment.deleted_at', '=', null);})->count();
            $public_note_comment_responses_list_count = DB::table('public_note_comment_response')->join('public_note_comment', 'public_note_comment.id', '=', 'public_note_comment_response.public_note_comment_id')->join('public_note', 'public_note.id', '=', 'public_note_comment.public_note_id')->where('public_note_comment_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_note_comment_response.deleted_at', '=', null);})->count();
            $public_note_likes_list_count = DB::table('public_note_like')->join('public_note', 'public_note.id', '=', 'public_note_like.public_note_id')->where('public_note_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_note_like.deleted_at', '=', null);})->count();
            
            $public_image_comments_list = DB::table('public_image_comment')->join('public_image', 'public_image.id', '=', 'public_image_comment.public_image_id')->select('public_image.id', 'public_image.name', 'public_image_comment.content', 'public_image_comment.created_at')->where('public_image_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_image_comment.deleted_at', '=', null);})->orderBy('public_image_comment.created_at', 'desc')->paginate(50, ['*'], 'image_comment_list_p');
            $public_image_comment_responses_list = DB::table('public_image_comment_response')->join('public_image_comment', 'public_image_comment.id', '=', 'public_image_comment_response.public_image_comment_id')->join('public_image', 'public_image.id', '=', 'public_image_comment.public_image_id')->select('public_image.id', 'public_image.name', 'public_image_comment_response.content', 'public_image_comment_response.created_at')->where('public_image_comment_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_image_comment_response.deleted_at', '=', null);})->orderBy('public_image_comment_response.created_at', 'desc')->paginate(50, ['*'], 'image_comment_response_list_p');
            $public_image_likes_list_c = DB::table('public_image_like')->join('public_image', 'public_image.id', '=', 'public_image_like.public_image_id')->select('public_image.id', 'public_image.name', 'public_image_like.created_at')->where('public_image_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_image_like.deleted_at', '=', null);})->orderBy('public_image_like.created_at', 'desc')->paginate(50, ['*'], 'image_like_list_p');
    
            $public_image_comments_list_count = DB::table('public_image_comment')->join('public_image', 'public_image.id', '=', 'public_image_comment.public_image_id')->where('public_image_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_image_comment.deleted_at', '=', null);})->count();
            $public_image_comment_responses_list_count = DB::table('public_image_comment_response')->join('public_image_comment', 'public_image_comment.id', '=', 'public_image_comment_response.public_image_comment_id')->join('public_image', 'public_image.id', '=', 'public_image_comment.public_image_id')->where('public_image_comment_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_image_comment_response.deleted_at', '=', null);})->count();
            $public_image_likes_list_count = DB::table('public_image_like')->join('public_image', 'public_image.id', '=', 'public_image_like.public_image_id')->where('public_image_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_image_like.deleted_at', '=', null);})->count();

            $public_audio_comments_list = DB::table('public_audio_comment')->join('public_audio', 'public_audio.id', '=', 'public_audio_comment.public_audio_id')->select('public_audio.id', 'public_audio.name', 'public_audio_comment.content', 'public_audio_comment.created_at')->where('public_audio_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_audio_comment.deleted_at', '=', null);})->orderBy('public_audio_comment.created_at', 'desc')->paginate(50, ['*'], 'audio_comment_list_p');
            $public_audio_comment_responses_list = DB::table('public_audio_comment_response')->join('public_audio_comment', 'public_audio_comment.id', '=', 'public_audio_comment_response.public_audio_comment_id')->join('public_audio', 'public_audio.id', '=', 'public_audio_comment.public_audio_id')->select('public_audio.id', 'public_audio.name', 'public_audio_comment_response.content', 'public_audio_comment_response.created_at')->where('public_audio_comment_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_audio_comment_response.deleted_at', '=', null);})->orderBy('public_audio_comment_response.created_at', 'desc')->paginate(50, ['*'], 'audio_comment_response_list_p');
            $public_audio_likes_list_c = DB::table('public_audio_like')->join('public_audio', 'public_audio.id', '=', 'public_audio_like.public_audio_id')->select('public_audio.id', 'public_audio.name', 'public_audio_like.created_at')->where('public_audio_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_audio_like.deleted_at', '=', null);})->orderBy('public_audio_like.created_at', 'desc')->paginate(50, ['*'], 'audio_like_list_p');
    
            $public_audio_comments_list_count = DB::table('public_audio_comment')->join('public_audio', 'public_audio.id', '=', 'public_audio_comment.public_audio_id')->where('public_audio_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_audio_comment.deleted_at', '=', null);})->count();
            $public_audio_comment_responses_list_count = DB::table('public_audio_comment_response')->join('public_audio_comment', 'public_audio_comment.id', '=', 'public_audio_comment_response.public_audio_comment_id')->join('public_audio', 'public_audio.id', '=', 'public_audio_comment.public_audio_id')->where('public_audio_comment_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_audio_comment_response.deleted_at', '=', null);})->count();
            $public_audio_likes_list_count = DB::table('public_audio_like')->join('public_audio', 'public_audio.id', '=', 'public_audio_like.public_audio_id')->where('public_audio_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_audio_like.deleted_at', '=', null);})->count();

            $public_video_comments_list = DB::table('public_video_comment')->join('public_video', 'public_video.id', '=', 'public_video_comment.public_video_id')->select('public_video.id', 'public_video.name', 'public_video_comment.content', 'public_video_comment.created_at')->where('public_video_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_video_comment.deleted_at', '=', null);})->orderBy('public_video_comment.created_at', 'desc')->paginate(50, ['*'], 'video_comment_list_p');
            $public_video_comment_responses_list = DB::table('public_video_comment_response')->join('public_video_comment', 'public_video_comment.id', '=', 'public_video_comment_response.public_video_comment_id')->join('public_video', 'public_video.id', '=', 'public_video_comment.public_video_id')->select('public_video.id', 'public_video.name', 'public_video_comment_response.content', 'public_video_comment_response.created_at')->where('public_video_comment_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_video_comment_response.deleted_at', '=', null);})->orderBy('public_video_comment_response.created_at', 'desc')->paginate(50, ['*'], 'video_comment_response_list_p');
            $public_video_likes_list_c = DB::table('public_video_like')->join('public_video', 'public_video.id', '=', 'public_video_like.public_video_id')->select('public_video.id', 'public_video.name', 'public_video_like.created_at')->where('public_video_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_video_like.deleted_at', '=', null);})->orderBy('public_video_like.created_at', 'desc')->paginate(50, ['*'], 'video_like_list_p');
    
            $public_video_comments_list_count = DB::table('public_video_comment')->join('public_video', 'public_video.id', '=', 'public_video_comment.public_video_id')->where('public_video_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_video_comment.deleted_at', '=', null);})->count();
            $public_video_comment_responses_list_count = DB::table('public_video_comment_response')->join('public_video_comment', 'public_video_comment.id', '=', 'public_video_comment_response.public_video_comment_id')->join('public_video', 'public_video.id', '=', 'public_video_comment.public_video_id')->where('public_video_comment_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_video_comment_response.deleted_at', '=', null);})->count();
            $public_video_likes_list_count = DB::table('public_video_like')->join('public_video', 'public_video.id', '=', 'public_video_like.public_video_id')->where('public_video_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_video_like.deleted_at', '=', null);})->count();

            $public_advertisement_comments_list = DB::table('public_advertisement_comment')->join('public_advertisement', 'public_advertisement.id', '=', 'public_advertisement_comment.public_advertisement_id')->select('public_advertisement.id', 'public_advertisement.name', 'public_advertisement_comment.content', 'public_advertisement_comment.created_at')->where('public_advertisement_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_advertisement_comment.deleted_at', '=', null);})->orderBy('public_advertisement_comment.created_at', 'desc')->paginate(50, ['*'], 'advertisement_comment_list_p');
            $public_advertisement_comment_responses_list = DB::table('public_advertisement_c_response')->join('public_advertisement_comment', 'public_advertisement_comment.id', '=', 'public_advertisement_c_response.public_a_c_id')->join('public_advertisement', 'public_advertisement.id', '=', 'public_advertisement_comment.public_advertisement_id')->select('public_advertisement.id', 'public_advertisement.name', 'public_advertisement_c_response.content', 'public_advertisement_c_response.created_at')->where('public_advertisement_c_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_advertisement_c_response.deleted_at', '=', null);})->orderBy('public_advertisement_c_response.created_at', 'desc')->paginate(50, ['*'], 'advertisement_comment_response_list_p');
            $public_advertisement_likes_list_c = DB::table('public_advertisement_like')->join('public_advertisement', 'public_advertisement.id', '=', 'public_advertisement_like.public_advertisement_id')->select('public_advertisement.id', 'public_advertisement.name', 'public_advertisement_like.created_at')->where('public_advertisement_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_advertisement_like.deleted_at', '=', null);})->orderBy('public_advertisement_like.created_at', 'desc')->paginate(50, ['*'], 'advertisement_like_list_p');
    
            $public_advertisement_comments_list_count = DB::table('public_advertisement_comment')->join('public_advertisement', 'public_advertisement.id', '=', 'public_advertisement_comment.public_advertisement_id')->where('public_advertisement_comment.user_id', '=', $user_id)->where(function ($query) {$query->where('public_advertisement_comment.deleted_at', '=', null);})->count();
            $public_advertisement_comment_responses_list_count = DB::table('public_advertisement_c_response')->join('public_advertisement_comment', 'public_advertisement_comment.id', '=', 'public_advertisement_c_response.public_a_c_id')->join('public_advertisement', 'public_advertisement.id', '=', 'public_advertisement_comment.public_advertisement_id')->where('public_advertisement_c_response.user_id', '=', $user_id)->where(function ($query) {$query->where('public_advertisement_c_response.deleted_at', '=', null);})->count();
            $public_advertisement_likes_list_count = DB::table('public_advertisement_like')->join('public_advertisement', 'public_advertisement.id', '=', 'public_advertisement_like.public_advertisement_id')->where('public_advertisement_like.user_id', '=', $user_id)->where(function ($query) {$query->where('public_advertisement_like.deleted_at', '=', null);})->count();

            $files_list = DB::table('public_file')->where('user_id', $user_id)->where(function ($query) {$query->where('public_file.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
            $notes_list = DB::table('public_note')->where('user_id', $user_id)->where(function ($query) {$query->where('public_note.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
            $images_list = DB::table('public_image')->where('user_id', $user_id)->where(function ($query) {$query->where('public_image.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
            $audios_list = DB::table('public_audio')->where('user_id', $user_id)->where(function ($query) {$query->where('public_audio.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
            $videos_list = DB::table('public_video')->where('user_id', $user_id)->where(function ($query) {$query->where('public_video.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
            $advertisements_list = DB::table('public_advertisement')->where('user_id', $user_id)->where(function ($query) {$query->where('public_advertisement.deleted_at', '=', null);})->orderBy('created_at', 'desc')->limit(10)->get();
        }
        ...
        if(isset(Auth::user()->id))
        {
            return view('publicProfile')
                ...
                ->with('publicFileCommentsList', $public_file_comments_list)
                ->with('publicFileCommentResponsesList', $public_file_comment_responses_list)
                ->with('publicFileLikesListC', $public_file_likes_list_c)
                ->with('publicFileCommentsListCount', $public_file_comments_list_count)
                ->with('publicFileCommentResponsesListCount', $public_file_comment_responses_list_count)
                ->with('publicFileLikesListCount', $public_file_likes_list_count)
                ->with('publicNoteCommentsList', $public_note_comments_list)
                ->with('publicNoteCommentResponsesList', $public_note_comment_responses_list)
                ->with('publicNoteLikesListC', $public_note_likes_list_c)
                ->with('publicNoteCommentsListCount', $public_note_comments_list_count)
                ->with('publicNoteCommentResponsesListCount', $public_note_comment_responses_list_count)
                ->with('publicNoteLikesListCount', $public_note_likes_list_count)
                ->with('publicImageCommentsList', $public_image_comments_list)
                ->with('publicImageCommentResponsesList', $public_image_comment_responses_list)
                ->with('publicImageLikesListC', $public_image_likes_list_c)
                ->with('publicImageCommentsListCount', $public_image_comments_list_count)
                ->with('publicImageCommentResponsesListCount', $public_image_comment_responses_list_count)
                ->with('publicImageLikesListCount', $public_image_likes_list_count)
                ->with('publicAudioCommentsList', $public_audio_comments_list)
                ->with('publicAudioCommentResponsesList', $public_audio_comment_responses_list)
                ->with('publicAudioLikesListC', $public_audio_likes_list_c)
                ->with('publicAudioCommentsListCount', $public_audio_comments_list_count)
                ->with('publicAudioCommentResponsesListCount', $public_audio_comment_responses_list_count)
                ->with('publicAudioLikesListCount', $public_audio_likes_list_count)
                ->with('publicVideoCommentsList', $public_video_comments_list)
                ->with('publicVideoCommentResponsesList', $public_video_comment_responses_list)
                ->with('publicVideoLikesListC', $public_video_likes_list_c)
                ->with('publicVideoCommentsListCount', $public_video_comments_list_count)
                ->with('publicVideoCommentResponsesListCount', $public_video_comment_responses_list_count)
                ->with('publicVideoLikesListCount', $public_video_likes_list_count)
                ->with('publicAdvertisementCommentsList', $public_advertisement_comments_list)
                ->with('publicAdvertisementCommentResponsesList', $public_advertisement_comment_responses_list)
                ->with('publicAdvertisementLikesListC', $public_advertisement_likes_list_c)
                ->with('publicAdvertisementCommentsListCount', $public_advertisement_comments_list_count)
                ->with('publicAdvertisementCommentResponsesListCount', $public_advertisement_comment_responses_list_count)
                ->with('publicAdvertisementLikesListCount', $public_advertisement_likes_list_count);
        }
