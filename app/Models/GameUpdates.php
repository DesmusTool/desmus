 ...
 * @property \Illuminate\Database\Eloquent\Collection contactSocialCreates
 * @property \Illuminate\Database\Eloquent\Collection contactSocialDeletes
 * @property \Illuminate\Database\Eloquent\Collection contactSocialUpdates
 * @property \Illuminate\Database\Eloquent\Collection contactSocialViews
 ...
 * @property \Illuminate\Database\Eloquent\Collection gameCreates
 * @property \Illuminate\Database\Eloquent\Collection gameDeletes
 * @property \Illuminate\Database\Eloquent\Collection gameViews
 ...
 * @property \Illuminate\Database\Eloquent\Collection publicAdvertisementCResponse
 * @property \Illuminate\Database\Eloquent\Collection publicAdvertisementComment
 * @property \Illuminate\Database\Eloquent\Collection publicAdvertisementLike
 * @property \Illuminate\Database\Eloquent\Collection publicAdvertisementUpdates
 * @property \Illuminate\Database\Eloquent\Collection publicAdvertisementViews
 * @property \Illuminate\Database\Eloquent\Collection publicAudioComment
 * @property \Illuminate\Database\Eloquent\Collection publicAudioCommentResponse
 * @property \Illuminate\Database\Eloquent\Collection publicAudioLike
 * @property \Illuminate\Database\Eloquent\Collection publicAudioUpdates
 * @property \Illuminate\Database\Eloquent\Collection publicAudioViews
 * @property \Illuminate\Database\Eloquent\Collection publicFileComment
 * @property \Illuminate\Database\Eloquent\Collection publicFileCommentResponse
 * @property \Illuminate\Database\Eloquent\Collection publicFileLike
 * @property \Illuminate\Database\Eloquent\Collection publicFileUpdates
 * @property \Illuminate\Database\Eloquent\Collection publicFileViews
 * @property \Illuminate\Database\Eloquent\Collection publicImageComment
 * @property \Illuminate\Database\Eloquent\Collection publicImageCommentResponse
 * @property \Illuminate\Database\Eloquent\Collection publicImageLike
 * @property \Illuminate\Database\Eloquent\Collection publicImageUpdates
 * @property \Illuminate\Database\Eloquent\Collection publicImageViews
 * @property \Illuminate\Database\Eloquent\Collection publicNoteComment
 * @property \Illuminate\Database\Eloquent\Collection publicNoteCommentResponse
 * @property \Illuminate\Database\Eloquent\Collection publicNoteLike
 * @property \Illuminate\Database\Eloquent\Collection publicNoteUpdates
 * @property \Illuminate\Database\Eloquent\Collection publicNoteViews
 * @property \Illuminate\Database\Eloquent\Collection publicVideoComment
 * @property \Illuminate\Database\Eloquent\Collection publicVideoCommentResponse
 * @property \Illuminate\Database\Eloquent\Collection publicVideoLike
 * @property \Illuminate\Database\Eloquent\Collection publicVideoUpdates
 * @property \Illuminate\Database\Eloquent\Collection publicVideoViews
 ...
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileAudioC
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileAudioCResponse
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileAudioLike
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileAudioUpdates
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileAudioViews
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileFileC
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileFileCResponse
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileFileLike
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileFileUpdates
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileFileViews
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileImageC
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileImageCResponse
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileImageLike
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileImageUpdates
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileImageViews
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileNoteC
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileNoteCResponse
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileNoteLike
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileNoteUpdates
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileNoteViews
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileVideoC
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileVideoCResponse
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileVideoLike
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileVideoUpdates
 * @property \Illuminate\Database\Eloquent\Collection sharedProfileVideoViews
 ...
 * @property \Illuminate\Database\Eloquent\Collection userCalendarEventCreates
 * @property \Illuminate\Database\Eloquent\Collection userCalendarEventDeletes
 * @property \Illuminate\Database\Eloquent\Collection userCalendarEventUpdates
 * @property \Illuminate\Database\Eloquent\Collection userCalendarEvents
 ...
 * @property \Illuminate\Database\Eloquent\Collection userSharedProfileCreates
 * @property \Illuminate\Database\Eloquent\Collection userSharedProfileDeletes
 * @property \Illuminate\Database\Eloquent\Collection userSharedProfileUpdates
 * @property string actual_name
 * @property string past_name
 * @property string|\Carbon\Carbon datetime
 * @property integer user_id
 * @property integer game_id
 */
class GameUpdates extends Model
{
    use SoftDeletes;

    public $table = 'game_updates';
