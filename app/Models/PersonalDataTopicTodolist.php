...
/**
 * Class PersonalDataTopicTodolist
 * @package App\Models
 * @version May 29, 2018, 2:34 am UTC
 *
 * @property \App\Models\PersonalDataTopic personalDataTopic
 ...
 * @property integer views_quantity
 * @property integer updates_quantity
 * @property string status
 * @property string|\Carbon\Carbon datetime
 * @property integer p_d_t_id
 */
class PersonalDataTopicTodolist extends Model
{
    use SoftDeletes;

    public $table = 'personal_data_topic_todolists';
    ...
    protected $casts = [
        ...
        'updates_quantity' => 'integer',
        'status' => 'string',
        'personal_data_topic_id' => 'integer'
    ];
     ...
     **/
    public function personalDataTopic()
    {
        return $this->belongsTo(\App\Models\PersonalDataTopic::class);
    }
}
