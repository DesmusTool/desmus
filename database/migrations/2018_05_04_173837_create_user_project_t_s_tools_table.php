...
class CreateUserProjectTSToolsTable extends Migration
{
    public function up()
    {
        Schema::create('user_project_t_s_tools', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('user_project_t_s_tools');
    }
}