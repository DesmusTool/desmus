...
class CreateCollegeTSNoteUpdatesTable extends Migration
{
    public function up()
    {
        Schema::create('college_t_s_note_updates', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('college_t_s_note_updates');
    }
}