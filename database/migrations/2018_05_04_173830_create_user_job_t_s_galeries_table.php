...
class CreateUserJobTSGaleriesTable extends Migration
{
    public function up()
    {
        Schema::create('user_job_t_s_galeries', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('user_job_t_s_galeries');
    }
}