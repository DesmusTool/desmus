...
class CreateJobTSToolFileUpdatesTable extends Migration
{
    public function up()
    {
        Schema::create('job_t_s_tool_file_updates', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('job_t_s_tool_file_updates');
    }
}