...
class CreateProjectTSGaleryImageUpdatesTable extends Migration
{
    public function up()
    {
        Schema::create('project_t_s_galery_image_updates', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('project_t_s_galery_image_updates');
    }
}