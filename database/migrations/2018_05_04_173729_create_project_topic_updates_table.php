...
class CreateProjectTopicUpdatesTable extends Migration
{
    public function up()
    {
        Schema::create('project_topic_updates', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('project_topic_updates');
    }
}