...
class CreateUserCollegeTopicSectionsTable extends Migration
{
    public function up()
    {
        Schema::create('user_college_topic_sections', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('user_college_topic_sections');
    }
}