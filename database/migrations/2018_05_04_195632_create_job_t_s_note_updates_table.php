...
class CreateJobTSNoteUpdatesTable extends Migration
{
    public function up()
    {
        Schema::create('job_t_s_note_updates', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('job_t_s_note_updates');
    }
}