...
class CreatePersonalDataTSTodolistsTable extends Migration
{
    public function up()
    {
        Schema::create('personal_data_t_s_todolists', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('personal_data_t_s_todolists');
    }
}