...
class CreatePDTSPAudioUpdatesTable extends Migration
{
    public function up()
    {
        Schema::create('p_d_t_s_p_audio_updates', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('p_d_t_s_p_audio_updates');
    }
}