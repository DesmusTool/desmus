...
class CreateCollegeTopicUpdatesTable extends Migration
{
    public function up()
    {
        Schema::create('college_topic_updates', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('college_topic_updates');
    }
}