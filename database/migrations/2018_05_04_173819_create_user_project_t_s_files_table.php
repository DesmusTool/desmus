...
class CreateUserProjectTSFilesTable extends Migration
{
    public function up()
    {
        Schema::create('user_project_t_s_files', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('user_project_t_s_files');
    }
}