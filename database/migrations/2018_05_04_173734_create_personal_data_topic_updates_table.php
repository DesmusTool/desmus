...
class CreatePersonalDataTopicUpdatesTable extends Migration
{
    public function up()
    {
        Schema::create('personal_data_topic_updates', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('personal_data_topic_updates');
    }
}