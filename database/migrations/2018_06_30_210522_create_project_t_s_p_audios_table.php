...
class CreateProjectTSPAudiosTable extends Migration
{
    public function up()
    {
        Schema::create('project_t_s_p_audios', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('project_t_s_p_audios');
    }
}