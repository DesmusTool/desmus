...
class CreateCollegeTSToolFileUpdatesTable extends Migration
{
    public function up()
    {
        Schema::create('college_t_s_tool_file_updates', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('college_t_s_tool_file_updates');
    }
}