...
class CreateUserCollegeTSToolFilesTable extends Migration
{
    public function up()
    {
        Schema::create('user_college_t_s_tool_files', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('user_college_t_s_tool_files');
    }
}