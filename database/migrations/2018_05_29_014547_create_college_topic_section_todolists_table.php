...
class CreateCollegeTopicSectionTodolistsTable extends Migration
{
    public function up()
    {
        Schema::create('college_topic_section_todolists', function (Blueprint $table) {
            $table->engine='InnoDB';
            $table->charset='utf8';
    ...
    {
        Schema::dropIfExists('college_topic_section_todolists');
    }
}