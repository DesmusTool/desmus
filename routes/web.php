...
Route::resource('gameCreates', 'GameCreatesController');

Route::resource('gameUpdates', 'GameUpdatesController');

Route::resource('gameDeletes', 'GameDeletesController');

Route::resource('gameViews', 'GameViewsController');

Route::get('/GameSearch','GameSearchController@search');

Route::get('/PublicFileSearch', 'PublicFileSearchController@search');

Route::get('/PublicNoteSearch', 'PublicNoteSearchController@search');

Route::get('/PublicImageSearch', 'PublicImageSearchController@search');

Route::get('/PublicAudioSearch', 'PublicAudioSearchController@search');

Route::get('/PublicVideoSearch', 'PublicVideoSearchController@search');

Route::get('/PublicAdvertisementSearch', 'PublicAdvertisementSearchController@search');

Route::get('/SharedProfileFileSearch', 'SharedProfileFileSearchController@search');

Route::get('/SharedProfileNoteSearch', 'SharedProfileNoteSearchController@search');

Route::get('/SharedProfileImageSearch', 'SharedProfileImageSearchController@search');

Route::get('/SharedProfileAudioSearch', 'SharedProfileAudioSearchController@search');

Route::get('/SharedProfileVideoSearch', 'SharedProfileVideoSearchController@search');