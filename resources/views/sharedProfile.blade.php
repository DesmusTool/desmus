...
@section('scripts')
  ...
  <script>
    ...
    $('#sharedProfileFileSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('SharedProfileFileSearch')}}',
        data:{'search':$value},
 
        success:function(data){
          $('tbody#t_shared_profile_file_search').html(data);
        }
  ...
  <script>
    ...
    $('#sharedProfileNoteSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('SharedProfileNoteSearch')}}',
        data:{'search':$value},
 
        success:function(data){
          $('tbody#t_shared_profile_note_search').html(data);
        }
  ...
  <script>
    ...
    $('#sharedProfileImageSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        success:function(data){
          $('tbody#t_shared_profile_image_search').html(data);
        }
  ...
  <script>
    ...
    $('#sharedProfileAudioSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('SharedProfileAudioSearch')}}',
        data:{'search':$value},
 
        success:function(data){
          $('tbody#t_shared_profile_audio_search').html(data);
        }
  ...
  <script>
    ...
    $('#sharedProfileVideoSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('SharedProfileVideoSearch')}}',
        data:{'search':$value},
 
        success:function(data){
          $('tbody#t_shared_profile_video_search').html(data);
        }
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="nav-tabs-custom" style="margin-bottom: 10px;">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              <li><a href="#shared_profile_files_search" data-toggle="tab" aria-expanded="false"> Search Files </a></li>
                            ...
                            <div class="tab-content clearfix" style="padding: 10;">
                              ...
                              <div class = "tab-pane" id = "shared_profile_files_search">

                                <form action="#" method="get" class="sidebar-form">
                                
                                  <input type="text" class="form-control" id = "sharedProfileFileSearch" name = "search" placeholder="Search..."/>
                                 ...
                                 <table class="table table-responsive" style="margin-bottom: 0;">
                                  ...
                                  <tbody id = "t_shared_profile_file_search">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="nav-tabs-custom" style="margin-bottom: 10px;">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              <li><a href="#shared_profile_notes_search" data-toggle="tab" aria-expanded="false"> Search Notes </a></li>
                            ...
                            <div class="tab-content clearfix" style="padding: 10;">
                              ...
                              <div class = "tab-pane" id = "shared_profile_notes_search">

                                <form action="#" method="get" class="sidebar-form">
                                
                                  <input type="text" class="form-control" id = "sharedProfileNoteSearch" name = "search" placeholder="Search..."/>
                                 ...
                                 <table class="table table-responsive" style="margin-bottom: 0;">
                                  ...
                                  <tbody id = "t_shared_profile_note_search">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="nav-tabs-custom" style="margin-bottom: 10px;">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              <li><a href="#shared_profile_images_search" data-toggle="tab" aria-expanded="false"> Search Images </a></li>
                            ...
                            <div class="tab-content clearfix" style="padding: 10;">
                              ...
                              <div class = "tab-pane" id = "shared_profile_images_search">

                                <form action="#" method="get" class="sidebar-form">
                                
                                  <input type="text" class="form-control" id = "sharedProfileImageSearch" name = "search" placeholder="Search..."/>
                                 ...
                                 <table class="table table-responsive" style="margin-bottom: 0;">
                                  ...
                                  <tbody id = "t_shared_profile_image_search">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="nav-tabs-custom" style="margin-bottom: 10px;">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              <li><a href="#shared_profile_audios_search" data-toggle="tab" aria-expanded="false"> Search Audios </a></li>
                            ...
                            <div class="tab-content clearfix" style="padding: 10;">
                              ...
                              <div class = "tab-pane" id = "shared_profile_audios_search">

                                <form action="#" method="get" class="sidebar-form">
                                
                                  <input type="text" class="form-control" id = "sharedProfileAudioSearch" name = "search" placeholder="Search..."/>
                                 ...
                                 <table class="table table-responsive" style="margin-bottom: 0;">
                                  ...
                                  <tbody id = "t_shared_profile_audio_search">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="nav-tabs-custom" style="margin-bottom: 10px;">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              <li><a href="#shared_profile_videos_search" data-toggle="tab" aria-expanded="false"> Search Videos </a></li>
                            ...
                            <div class="tab-content clearfix" style="padding: 10;">
                              ...
                              <div class = "tab-pane" id = "shared_profile_videos_search">

                                <form action="#" method="get" class="sidebar-form">
                                
                                  <input type="text" class="form-control" id = "sharedProfileVideoSearch" name = "search" placeholder="Search..."/>
                                 ...
                                 <table class="table table-responsive" style="margin-bottom: 0;">
                                  ...
                                  <tbody id = "t_shared_profile_video_search">
