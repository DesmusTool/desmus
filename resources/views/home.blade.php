                    ...
                    <ul class="timeline">
                      ...
                      @foreach($recent_activities as $recent_activity)
                        ...
                        <li>
                          ...
                          @if($recent_activity -> type == 'u_s_p_c' || $recent_activity -> type == 'u_s_p_u' || $recent_activity -> type == 'u_s_p_d')
                          ...
                          @if($recent_activity -> type == 'g_c' || $recent_activity -> type == 'g_u' || $recent_activity -> type == 'g_d')
                          ...
                          <div class="timeline-item">
                            ...
                            <h3 class="timeline-header">
                              ...
                              @if($recent_activity -> type == 'g_c' || $recent_activity -> type == 'g_u' || $recent_activity -> type == 'g_d')
                                ...
                                the game <a href="{!! route('games.show', [$recent_activity -> entity_id]) !!}">{!! $recent_activity -> name !!}</a>
