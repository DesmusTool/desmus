...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1> {!! $projectTSFile[0] -> name !!} - Share List </h1>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="row" style="padding-left: 20px">
          ...
          @include('user_project_t_s_files.show_fields')
          <a href="{!! route('projectTopicSections.show', [$projectTSFile[0] -> project_topic_section_id]) !!}" class="btn btn-default">Back</a>
