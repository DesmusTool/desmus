...
@section('scripts')
  ...
  <script>
    ...
    $('#college_t_s_playlist_update').on('submit', function() {
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            {!! Form::model($collegeTSPlaylist, ['route' => ['collegeTSPlaylists.update', $collegeTSPlaylist->id], 'method' => 'patch',  'id' => 'college_t_s_playlist_update']) !!}
            
              @include('college_t_s_playlists.fields')
