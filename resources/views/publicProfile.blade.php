...
@section('scripts')
  ...
  <script>
    ...
    $('#publicFileSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('PublicFileSearch')}}',
        data:{'search':$value},
 
        success:function(data){
          $('tbody#t_public_file_search').html(data);
        }
  ...
  <script>
    ...
    $('#publicNoteSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('PublicNoteSearch')}}',
        data:{'search':$value},
 
        success:function(data){
          $('tbody#t_public_note_search').html(data);
        }
  ...
  <script>
    ...
    $('#publicImageSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('PublicImageSearch')}}',
        data:{'search':$value},
 
        success:function(data){
          $('tbody#t_public_image_search').html(data);
        }
  ...
  <script>
    ...
    $('#publicAudioSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('PublicAudioSearch')}}',
        data:{'search':$value},
 
        success:function(data){
          $('tbody#t_public_audio_search').html(data);
        }
  ...
  <script>
    ...
    $('#publicVideoSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('PublicVideoSearch')}}',
        data:{'search':$value},
 
        success:function(data){
          $('tbody#t_public_video_search').html(data);
        }
  ...
  <script>
    ...
    $('#publicAdvertisementSearch').on('keyup',function(){
      ...
      $.ajax({
        ...
        type : 'get',
        url : '{{URL::to('PublicAdvertisementSearch')}}',
        data:{'search':$value},
 
        success:function(data){
          $('tbody#t_public_advertisement_search').html(data);
        }
...
@section('content')
  ...
  <section class="content-header">
    ...
    <h1 class="pull-left">Public Profile</h1>
          ...
          <div class="col-md-12">
            ...
            <div class="nav-tabs-custom" style="margin-bottom: 10px;">
              ...
              <ul class="nav nav-tabs">
                ...
                <li class = "active"><a href="#public_section" data-toggle="tab"> Public Section </a></li>
                <li><a href="#public_files" data-toggle="tab"> Files </a></li>
              ...
              <div id = "tab-content" class="tab-content clearfix" style = "padding: 0;">
                ...
                <div class = "tab-pane active" id = "public_section">
                        ...
                        <div class="col-md-12" style="margin-top: 10px;">
                          ...
                          <div class="box box-primary" style="margin-bottom: 10px;">
                            ...
                            <div id="file_{!! $publicFile -> id  !!}" class="box-body">
                              ...
                              <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicFile -> description  !!} </p>
                        ...
                        <div class="col-md-12" style="margin-top: 10px;">
                          ...
                          <div class="box box-primary" style="margin-bottom: 10px;">
                            ...
                            <div id = "note_{!! $publicNote -> id !!}" class="box-body">
                              ...
                              <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicNote -> description  !!} </p>
                        ...
                        <div class="col-md-12" style="margin-top: 10px;">
                          ...
                          <div class="box box-primary" style="margin-bottom: 10px;">
                            ...
                            <div id="image_{!! $publicImage -> id !!}" class="box-body">
                              ...
                              <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicImage -> description  !!} </p>
                                        ...
                                        @if($publicImage -> id == $publicImageComment -> public_image_id)
                                          ...
                                          <div class="box-comment">
                                            ...
                                            <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                              ...
                                              <a href="{!! route('publicUser.show', [$publicImageComment -> user_id]) !!}">
                                                    ...
                                                    @if($publicImageComment -> id == $publicImageCommentResponse -> public_image_comment_id)
                                                      ...
                                                      <div style="margin-left: 10px;" class="box-comment">
                                                        ...
                                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                                          ...
                                                          <a href="{!! route('publicUser.show', [$publicImageCommentResponse -> user_id]) !!}">
                        ...
                        <div class="col-md-12" style="margin-top: 10px;">
                          ...
                          <div class="box box-primary" style="margin-bottom: 10px;">
                            ...
                            <div id="audio_{!! $publicAudio -> id !!}" class="box-body">
                              ...
                              <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicAudio -> description  !!} </p>
                        ...
                        <div class="col-md-12" style="margin-top: 10px;">
                          ...
                          <div class="box box-primary" style="margin-bottom: 10px;">
                            ...
                            <div id="video_{!! $publicVideo -> id  !!}" class="box-body">
                              ...
                              <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicVideo -> description  !!} </p>
                            ...
                            <div class="box-body" style="padding-left: 0; padding-right: 0;">
                              ...
                              <div class="col-md-12" style="padding-left: 10px; padding-right: 10px;">
                                ...
                                <div id="advertisement_{!! $publicAdvertisement -> id  !!}" class = "col-md-12" style="padding-left: 0; padding-right: 0">
                                  ...
                                  <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicAdvertisement -> description  !!} </p>
                                                        ...
                                                        @if($publicAdvertisementComment -> id == $publicAdvertisementCResponse -> public_a_c_id)
                                                          ...
                                                          <div style="margin-left: 10px;" class="box-comment">
                                                            ...
                                                            <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                                              ...
                                                              <a href="{!! route('publicUser.show', [$publicAdvertisementCResponse -> user_id]) !!}">
                ...
                <div class = "tab-pane" id = "public_files" style="margin: 10px;">
                          ...
                          <div class="nav-tabs-custom" style="margin-bottom: 10px;">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              @if(isset($user_id))
                                ...
                                <li><a href="#public_file_comments" data-toggle="tab" aria-expanded="false"> Public File Comments </a></li>
                                <li><a href="#public_file_comment_responses" data-toggle="tab" aria-expanded="false"> Public File Comment Responses </a></li>
                                <li><a href="#public_file_likes" data-toggle="tab" aria-expanded="false"> Public File Likes </a></li>
                    
                              @endif
                              
                              <li><a href="#public_files_search" data-toggle="tab" aria-expanded="false"> Search Files </a></li>
                            ...
                            <div class="tab-content clearfix" style="padding: 10;">
                                      ...
                                      <div class="col-md-12" style="margin-top: 10px;">
                                        ...
                                        <div class="box box-primary" style="margin-bottom: 0;">
                                          ...
                                          <div id="file_list_{!! $publicFileList -> id  !!}" class="box-body">
                                            ...
                                            <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicFileList -> description  !!} </p>
                              ...
                              <div class = "tab-pane" id = "public_files_search">

                                <form action="#" method="get" class="sidebar-form">
                                
                                  <input type="text" class="form-control" id = "publicFileSearch" name = "search" placeholder="Search..."/>
                              ...
                              @if(isset($user_id))
                                ...
                                <div class="tab-pane" id="public_file_comments">
                                  ...
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    ...
                                    {!! $publicFileCommentsListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicFileCommentsList as $publicFileCommentList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicFiles.show', [$publicFileCommentList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicFileCommentList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicFileCommentList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicFileCommentList -> content !!}
                                ...
                                <div class="tab-pane" id="public_file_comment_responses">
                                  
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    
                                    {!! $publicFileCommentResponsesListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicFileCommentResponsesList as $publicFileCommentResponseList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicFiles.show', [$publicFileCommentResponseList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicFileCommentResponseList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicFileCommentResponseList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicFileCommentResponseList -> content !!}
                                          ...
                                          <div class="col-sm-12">
                                            ...
                                            <div class="small-box bg-green">
                                              ...
                                              <div class="inner">
                                                ...
                                                <h3><sup style="font-size: 20px">{!! $publicFileLikesListCount !!}</sup></h3>
                                            ...
                                            <div class="table-responsive">
                                              ...
                                              <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" style="margin-bottom: 0;">
                                                ...
                                                <tbody>
                                                  ...
                                                  @foreach($publicFileLikesListC as $publicFileLikeList)
                        
                                                    <tr role="row" class="odd">
                                                    
                                                      <td class=""> <a href="{!! route('publicFiles.show', [$publicFileLikeList -> id]) !!}"> {!! $publicFileLikeList->name !!} </a> </td>
                                                      
                                                      <td class=""> {!! $publicFileLikeList->created_at !!} </td>
                          ...
                          <div class="nav-tabs-custom" style="margin-bottom: 10px;">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              @if(isset($user_id))
                                ...
                                <li><a href="#public_note_comments" data-toggle="tab" aria-expanded="false"> Public Note Comments </a></li>
                                <li><a href="#public_note_comment_responses" data-toggle="tab" aria-expanded="false"> Public Note Comment Responses </a></li>
                                <li><a href="#public_note_likes" data-toggle="tab" aria-expanded="false"> Public Note Likes </a></li>
                    
                              @endif
                              
                              <li><a href="#public_notes_search" data-toggle="tab" aria-expanded="false"> Search Notes </a></li>
                            ...
                            <div class="tab-content clearfix" style="padding: 10;">
                                      ...
                                      <div class="col-md-12" style="margin-top: 10px;">
                                        ...
                                        <div class="box box-primary" style="margin-bottom: 0;">
                                          ...
                                          <div id = "note_list_{!! $publicNoteList -> id !!}" class="box-body">
                                            ...
                                            <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicNoteList -> description  !!} </p>
                              ...
                              <div class = "tab-pane" id = "public_notes_search">

                                <form action="#" method="get" class="sidebar-form">
                                
                                  <input type="text" class="form-control" id = "publicNoteSearch" name = "search" placeholder="Search..."/>
                              ...
                              @if(isset($user_id))
                                ...
                                <div class="tab-pane" id="public_note_comments">
                                  ...
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    ...
                                    {!! $publicNoteCommentsListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicNoteCommentsList as $publicNoteCommentList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicNotes.show', [$publicNoteCommentList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicNoteCommentList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicNoteCommentList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicNoteCommentList -> content !!}
                                ...
                                <div class="tab-pane" id="public_note_comment_responses">
                                  
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    
                                    {!! $publicNoteCommentResponsesListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicNoteCommentResponsesList as $publicNoteCommentResponseList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicNotes.show', [$publicNoteCommentResponseList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicNoteCommentResponseList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicNoteCommentResponseList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicNoteCommentResponseList -> content !!}
                                          ...
                                          <div class="col-sm-12">
                                            ...
                                            <div class="small-box bg-green">
                                              ...
                                              <div class="inner">
                                                ...
                                                <h3><sup style="font-size: 20px">{!! $publicNoteLikesListCount !!}</sup></h3>
                                            ...
                                            <div class="table-responsive">
                                              ...
                                              <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" style="margin-bottom: 0;">
                                                ...
                                                <tbody>
                                                  ...
                                                  @foreach($publicNoteLikesListC as $publicNoteLikeList)
                        
                                                    <tr role="row" class="odd">
                                                    
                                                      <td class=""> <a href="{!! route('publicNotes.show', [$publicNoteLikeList -> id]) !!}"> {!! $publicNoteLikeList->name !!} </a> </td>
                                                      
                                                      <td class=""> {!! $publicNoteLikeList->created_at !!} </td>
                          ...
                          <div class="nav-tabs-custom" style="margin-bottom: 10px;">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              @if(isset($user_id))
                                ...
                                <li><a href="#public_image_comments" data-toggle="tab" aria-expanded="false"> Public Image Comments </a></li>
                                <li><a href="#public_image_comment_responses" data-toggle="tab" aria-expanded="false"> Public Image Comment Responses </a></li>
                                <li><a href="#public_image_likes" data-toggle="tab" aria-expanded="false"> Public Image Likes </a></li>
                    
                              @endif
                              
                              <li><a href="#public_images_search" data-toggle="tab" aria-expanded="false"> Search Images </a></li>
                            ...
                            <div class="tab-content clearfix" style="padding: 10;">
                                      ...
                                      <div class="col-md-12" style="margin-top: 10px;">
                                        ...
                                        <div class="box box-primary" style="margin-bottom: 0;">
                                          ...
                                          <div id="image_list_{!! $publicImageList -> id !!}" class="box-body">
                                            ...
                                            <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicImageList -> description  !!} </p>
                              ...
                              <div class = "tab-pane" id = "public_images_search">

                                <form action="#" method="get" class="sidebar-form">
                                
                                  <input type="text" class="form-control" id = "publicImageSearch" name = "search" placeholder="Search..."/>
                                 ...
                                 <table class="table table-responsive" style="margin-bottom: 0;">
                                  ...
                                  <tbody id = "t_public_image_search">
                              ...
                              @if(isset($user_id))
                                ...
                                <div class="tab-pane" id="public_image_comments">
                                  
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    
                                    {!! $publicImageCommentsListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicImageCommentsList as $publicImageCommentList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicImages.show', [$publicImageCommentList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicImageCommentList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicImageCommentList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicImageCommentList -> content !!}
                                ...
                                <div class="tab-pane" id="public_image_comment_responses">
                                  
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    
                                    {!! $publicImageCommentResponsesListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicImageCommentResponsesList as $publicImageCommentResponseList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicImages.show', [$publicImageCommentResponseList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicImageCommentResponseList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicImageCommentResponseList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicImageCommentResponseList -> content !!}
                                ...
                                <div class="tab-pane" id="public_image_likes">
                                          ...
                                          <div class="col-sm-12">
                                            ...
                                            <div class="small-box bg-green">
                                              ...
                                              <div class="inner">
                                                ...
                                                <h3><sup style="font-size: 20px">{!! $publicImageLikesListCount !!}</sup></h3>
                                            ...
                                            <div class="table-responsive">
                                              ...
                                              <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" style="margin-bottom: 0;">
                                                ...
                                                <tbody>
                                                  ...
                                                  @foreach($publicImageLikesListC as $publicImageLikeList)
                        
                                                    <tr role="row" class="odd">
                                                    
                                                      <td class=""> <a href="{!! route('publicImages.show', [$publicImageLikeList -> id]) !!}"> {!! $publicImageLikeList->name !!} </a> </td>
                                                      
                                                      <td class=""> {!! $publicImageLikeList->created_at !!} </td>
                          ...
                          <div class="nav-tabs-custom" style="margin-bottom: 10px;">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              @if(isset($user_id))
                                ...
                                <li><a href="#public_audio_comments" data-toggle="tab" aria-expanded="false"> Public Audio Comments </a></li>
                                <li><a href="#public_audio_comment_responses" data-toggle="tab" aria-expanded="false"> Public Audio Comment Responses </a></li>
                                <li><a href="#public_audio_likes" data-toggle="tab" aria-expanded="false"> Public Audio Likes </a></li>
                    
                              @endif
                              
                              <li><a href="#public_audios_search" data-toggle="tab" aria-expanded="false"> Search Audios </a></li>
                            ...
                            <div class="tab-content clearfix" style="padding: 10;">
                                      ...
                                      <div class="col-md-12" style="margin-top: 10px;">
                                        ...
                                        <div class="box box-primary" style="margin-bottom: 0;">
                                          ...
                                          <div id="audio_list_{!! $publicAudioList -> id !!}" class="box-body">
                                            ...
                                            <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicAudioList -> description  !!} </p>
                              ...
                              <div class = "tab-pane" id = "public_audios_search">

                                <form action="#" method="get" class="sidebar-form">
                                
                                  <input type="text" class="form-control" id = "publicAudioSearch" name = "search" placeholder="Search..."/>
                                 ...
                                 <table class="table table-responsive" style="margin-bottom: 0;">
                                  ...
                                  <tbody id = "t_public_audio_search">
                              ...
                              @if(isset($user_id))
                                ...
                                <div class="tab-pane" id="public_audio_comments">
                                  ...
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    ...
                                    {!! $publicAudioCommentsListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicAudioCommentsList as $publicAudioCommentList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicAudios.show', [$publicAudioCommentList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicAudioCommentList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicAudioCommentList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicAudioCommentList -> content !!}
                                ...
                                <div class="tab-pane" id="public_audio_comment_responses">
                                  
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    
                                    {!! $publicAudioCommentResponsesListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicAudioCommentResponsesList as $publicAudioCommentResponseList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicAudios.show', [$publicAudioCommentResponseList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicAudioCommentResponseList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicAudioCommentResponseList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicAudioCommentResponseList -> content !!}
                                          ...
                                          <div class="col-sm-12">
                                            ...
                                            <div class="small-box bg-green">
                                              ...
                                              <div class="inner">
                                                ...
                                                <h3><sup style="font-size: 20px">{!! $publicAudioLikesListCount !!}</sup></h3>
                                            ...
                                            <div class="table-responsive">
                                              ...
                                              <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" style="margin-bottom: 0;">
                                                ...
                                                <tbody>
                                                  ...
                                                  @foreach($publicAudioLikesListC as $publicAudioLikeList)
                        
                                                    <tr role="row" class="odd">
                                                    
                                                      <td class=""> <a href="{!! route('publicAudios.show', [$publicAudioLikeList -> id]) !!}"> {!! $publicAudioLikeList->name !!} </a> </td>
                                                      
                                                      <td class=""> {!! $publicAudioLikeList->created_at !!} </td>
                          ...
                          <div class="nav-tabs-custom" style="margin-bottom: 10px;">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              @if(isset($user_id))
                                ...
                                <li><a href="#public_video_comments" data-toggle="tab" aria-expanded="false"> Public Video Comments </a></li>
                                <li><a href="#public_video_comment_responses" data-toggle="tab" aria-expanded="false"> Public Video Comment Responses </a></li>
                                <li><a href="#public_video_likes" data-toggle="tab" aria-expanded="false"> Public Video Likes </a></li>
                    
                              @endif
                              
                              <li><a href="#public_videos_search" data-toggle="tab" aria-expanded="false"> Search Videos </a></li>
                            ...
                            <div class="tab-content clearfix" style="padding: 10;">
                                      ...
                                      <div class="col-md-12" style="margin-top: 10px;">
                                        ...
                                        <div class="box box-primary" style="margin-bottom: 0;">
                                          ...
                                          <div id="video_list_{!! $publicVideoList -> id  !!}" class="box-body">
                                            ...
                                            <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicVideoList -> description  !!} </p>
                              ...
                              <div class = "tab-pane" id = "public_videos_search">

                                <form action="#" method="get" class="sidebar-form">
                                
                                  <input type="text" class="form-control" id = "publicVideoSearch" name = "search" placeholder="Search..."/>
                                 ...
                                 <table class="table table-responsive" style="margin-bottom: 0;">
                                  ...
                                  <tbody id = "t_public_video_search">
                              ...
                              @if(isset($user_id))
                                ...
                                <div class="tab-pane" id="public_video_comments">
                                  ...
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    ...
                                    {!! $publicVideoCommentsListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicVideoCommentsList as $publicVideoCommentList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicVideos.show', [$publicVideoCommentList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicVideoCommentList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicVideoCommentList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicVideoCommentList -> content !!}
                                ...
                                <div class="tab-pane" id="public_video_comment_responses">
                                  
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    
                                    {!! $publicVideoCommentResponsesListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicVideoCommentResponsesList as $publicVideoCommentResponseList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicVideos.show', [$publicVideoCommentResponseList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicVideoCommentResponseList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicVideoCommentResponseList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicVideoCommentResponseList -> content !!}
                                          ...
                                          <div class="col-sm-12">
                                            ...
                                            <div class="small-box bg-green">
                                              ...
                                              <div class="inner">
                                                ...
                                                <h3><sup style="font-size: 20px">{!! $publicVideoLikesListCount !!}</sup></h3>
                                            ...
                                            <div class="table-responsive">
                                              ...
                                              <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" style="margin-bottom: 0;">
                                                ...
                                                <tbody>
                                                  ...
                                                  @foreach($publicVideoLikesListC as $publicVideoLikeList)
                        
                                                    <tr role="row" class="odd">
                                                    
                                                      <td class=""> <a href="{!! route('publicVideos.show', [$publicVideoLikeList -> id]) !!}"> {!! $publicVideoLikeList->name !!} </a> </td>
                                                      
                                                      <td class=""> {!! $publicVideoLikeList->created_at !!} </td>
                          ...
                          <div class="nav-tabs-custom" style="margin-bottom: 10px;">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              @if(isset($user_id))
                                ...
                                <li><a href="#public_advertisement_comments" data-toggle="tab" aria-expanded="false"> Public Advertisement Comments </a></li>
                                <li><a href="#public_advertisement_comment_responses" data-toggle="tab" aria-expanded="false"> Public Advertisement Comment Responses </a></li>
                                <li><a href="#public_advertisement_likes" data-toggle="tab" aria-expanded="false"> Public Advertisement Likes </a></li>
                    
                              @endif
                              
                              <li><a href="#public_advertisements_search" data-toggle="tab" aria-expanded="false"> Search Advertisements </a></li>
                            ...
                            <div class="tab-content clearfix" style="padding: 10;">
                                          ...
                                          <div class="box-body" style="padding-left: 0; padding-right: 0;">
                                            ...
                                            <div class="col-md-12" style="padding-left: 10px; padding-right: 10px;">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                      ...
                                                      <div class="description-block">
                                                        ...
                                                        <h5 class="description-header" style = "margin-bottom: 10px;">Telephone</h5>
                                                        <span class="description-text"> <a href="tel:{!! $publicAdvertisementList -> telephone !!}" style="font-size: 13px;"> {!! $publicAdvertisementList -> telephone !!} </a> </span>
                                              ...
                                              <div id="advertisement_list_{!! $publicAdvertisementList -> id  !!}" class = "col-md-12" style="padding-left: 0; padding-right: 0">
                                                ...
                                                <p class="text-muted well well-sm no-shadow" style="margin-top: 10px; margin-bottom: 15px; text-align: justify;"> {!! $publicAdvertisementList -> description  !!} </p>
                              ...
                              <div class = "tab-pane" id = "public_advertisements_search">

                                <form action="#" method="get" class="sidebar-form">
                                
                                  <input type="text" class="form-control" id = "publicAdvertisementSearch" name = "search" placeholder="Search..."/>
                                 ...
                                 <table class="table table-responsive" style="margin-bottom: 0;">
                                  ...
                                  <tbody id = "t_public_advertisement_search">
                              ...
                              @if(isset($user_id))
                                ...
                                <div class="tab-pane" id="public_advertisement_comments">
                                  ...
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    ...
                                    {!! $publicAdvertisementCommentsListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicAdvertisementCommentsList as $publicAdvertisementCommentList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicAdvertisements.show', [$publicAdvertisementCommentList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicAdvertisementCommentList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicAdvertisementCommentList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicAdvertisementCommentList -> content !!}
                                ...
                                <div class="tab-pane" id="public_advertisement_comment_responses">
                                  
                                  <span class="pull-right text-muted" style="background: rgba(0,0,0,0.2); color: #fff; margin: 10px; padding: 0 5px;">
                                    
                                    {!! $publicAdvertisementCommentResponsesListCount !!} comments
                                  
                                  </span>
                                  
                                  <div class="box-footer box-comments" style="padding-top: 40px;">
                                    
                                    @foreach($publicAdvertisementCommentResponsesList as $publicAdvertisementCommentResponseList)
                                      ...
                                      <div class="box-comment">
                                        ...
                                        <div class="comment-text" style="text-align:justify; padding-right: 10px;">
                                          ...
                                          <a href="{!! route('publicAdvertisements.show', [$publicAdvertisementCommentResponseList -> id]) !!}">
                                            
                                            <span class="username">
                                              
                                              {!! $publicAdvertisementCommentResponseList -> name !!}
                                              
                                              <span class="text-muted pull-right" style="background: rgba(0,0,0,0.1); color: #000; padding: 0 5px;">{!! $publicAdvertisementCommentResponseList -> created_at !!}</span>
                                              
                                            </span>
                                            
                                          </a>
                                          
                                          {!! $publicAdvertisementCommentResponseList -> content !!}
                                          ...
                                          <div class="col-sm-12">
                                            ...
                                            <div class="small-box bg-green">
                                              ...
                                              <div class="inner">
                                                ...
                                                <h3><sup style="font-size: 20px">{!! $publicAdvertisementLikesListCount !!}</sup></h3>
                                              ...
                                              <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" style="margin-bottom: 0;">
                                                ...
                                                <thead>
                                                  ...
                                                  <tr role="row">
                                                    ...
                                                    <th class="sorting_desc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 224px;" aria-sort="descending"> Advertisement Name </th>
                                                ...
                                                <tbody>
                                                  ...
                                                  @foreach($publicAdvertisementLikesListC as $publicAdvertisementLikeList)
                        
                                                    <tr role="row" class="odd">
                                                    
                                                      <td class=""> <a href="{!! route('publicAdvertisements.show', [$publicAdvertisementLikeList -> id]) !!}"> {!! $publicAdvertisementLikeList->name !!} </a> </td>
                                                      
                                                      <td class=""> {!! $publicAdvertisementLikeList->created_at !!} </td>
